...
`),e.write(`\x1B[1;31m└────────────────────────────────────────────────────────────────────────┘\x1B[0m\r
\r
`)}function fe(e,t){let n=e.theme||t.theme||`dark-modern`,r=Object.assign({},hr[n]||hr[`dark-modern`]);e.background&&(r.background=e.background),e.cursorColor&&(r.cursor=e.cursorColor),e.selectionColor&&(r.selectionBackground=e.selectionColor),e.ansiColors&&typeof e.ansiColors==`object`&&Object.assign(r,e.ansiColors);let i=new Terminal({fontFamily:e.fontFamily||t.fontFamily,fontSize:e.fontSize||t.fontSize,cursorBlink:e.cursorBlink===void 0?t.cursorBlink:e.cursorBlink,cursorStyle:e.cursorStyle||t.cursorStyle||`block`,scrollback:e.scrollback||t.scrollback||1e4,cols:e.cols>0?e.cols:80,rows:e.rows>0?e.rows:24,theme:r,allowTransparency:!0,smoothScrollDuration:120,scrollSensitivity:1.5,fastScrollSensitivity:5}),a=null;try{typeof FitAddon<`u`&&(a=typeof FitAddon.FitAddon==`function`?new FitAddon.FitAddon:new FitAddon,i.loadAddon(a))}catch(e){console.warn(`FitAddon error:`,e)}let o=null;try{typeof SearchAddon<`u`&&(o=typeof SearchAddon.SearchAddon==`function`?new SearchAddon.SearchAddon:new SearchAddon,i.loadAddon(o))}catch(e){console.warn(`SearchAddon error:`,e)}return{term:i,fitAddon:a,searchAddon:o}}function pe(e,t,n,r){if(!r)return null;let i=t.querySelector(`.pane-terminal-top`)||t,a=document.createElement(`div`);a.className=`terminal-search-bar hidden`,a.id=`termSearchBar_${e}`,a.setAttribute(`role`,`search`),a.innerHTML=`
...
`).map(e=>e.replace(/\s+$/,``)).filter(e=>e.trim().length),Jt(Kt,e),S(`Startup commands saved — they run next time you connect`,`success`)}}var nn=`modulepreload`,rn=function(e){return`/`+e},an={},on=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=rn(t,n),t=s(t),t in an)return;an[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:nn,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},sn=o({activateHomeTab:()=>Nn,activateTab:()=>Pn,addMultiExecDataListener:()=>bn,broadcastMultiExecData:()=>xn,cancelReconnection:()=>hn,closeTab:()=>Fn,connectToSession:()=>V,createTab:()=>Rn,duplicateTab:()=>Ln,executeReconnectAttempt:()=>vn,findTabBySessionId:()=>In,getTabReconnectBanner:()=>un,hideReconnectBanner:()=>dn,isAutoLogEnabled:()=>wn,maybeLogSessionData:()=>Dn,registerDualPaneSFTP:()=>ln,scheduleReconnectAttempt:()=>_n,sendMultiExec:()=>An,setAutoLog:()=>Tn,showReconnectFailedBanner:()=>mn,showReconnectPromptBanner:()=>fn,showTabColorPalette:()=>Vn,showTabContextMenu:()=>Bn,startLocalTerminal:()=>zn,startReconnectionSequence:()=>gn,toggleMultiExec:()=>kn,toggleSessionLogging:()=>On,updateReconnectProgressBanner:()=>pn}),cn=null;function ln(e){cn=e}function un(e){let n=t[e];return!n||!n.paneEl?null:n.paneEl.querySelector(`#reconnectBanner_${e}`)}function dn(e){let n=un(e);n&&n.remove(),t[e]&&(t[e].awaitingReconnectPrompt=!1)}function fn(e,n,r){let i=t[e];if(!i||!i.paneEl)return;dn(e);let a=i.paneEl.querySelector(`.pane-terminal-top`)||i.paneEl,o=document.createElement(`div`);o.className=`reconnect-banner`,o.id=`reconnectBanner_${e}`,o.innerHTML=`
  ...
  `,a.appendChild(o),i.awaitingReconnectPrompt=!0;let s=o.querySelector(`#btnRecNow_${e}`);s&&(s.onclick=()=>{dn(e),gn(e,!0)});let c=o.querySelector(`#btnRecAuto_${e}`);c&&(c.onclick=()=>{dn(e),gn(e,!1)});let l=o.querySelector(`#btnRecDismiss_${e}`);l&&(l.onclick=()=>{dn(e),i.term&&i.term.write(`\r
\x1B[90m● Reconnection prompt dismissed.\x1B[0m\r
`)})}function pn(e,n,r,i){let a=t[e];if(!a||!a.paneEl)return;let o=un(e),s=a.paneEl.querySelector(`.pane-terminal-top`)||a.paneEl;o||(o=document.createElement(`div`),o.id=`reconnectBanner_${e}`,s.appendChild(o)),o.className=`reconnect-banner in-progress`,o.innerHTML=`
    <div class="reconnect-banner-left">
  ...
  `;let c=o.querySelector(`#btnRecForceNow_${e}`);c&&(c.onclick=()=>{a.reconnectState&&(a.reconnectState.timerId&&clearTimeout(a.reconnectState.timerId),a.reconnectState.countdownTimerId&&clearInterval(a.reconnectState.countdownTimerId)),vn(e,n)});let l=o.querySelector(`#btnRecCancel_${e}`);l&&(l.onclick=()=>{hn(e)})}function mn(e,n){let r=t[e];if(!r||!r.paneEl)return;let i=un(e),a=r.paneEl.querySelector(`.pane-terminal-top`)||r.paneEl;i||(i=document.createElement(`div`),i.id=`reconnectBanner_${e}`,a.appendChild(i)),i.className=`reconnect-banner failed`,i.innerHTML=`
    <div class="reconnect-banner-left">
      <span class="reconnect-pulse-icon">❌</span>
      <div>
  ...
  `;let o=i.querySelector(`#btnRecRetryLoop_${e}`);o&&(o.onclick=()=>{dn(e),gn(e,!0)});let s=i.querySelector(`#btnRecDismissFailed_${e}`);s&&(s.onclick=()=>{dn(e)})}function hn(e){let n=t[e];n&&(n.reconnectState&&(n.reconnectState.timerId&&clearTimeout(n.reconnectState.timerId),n.reconnectState.countdownTimerId&&clearInterval(n.reconnectState.countdownTimerId),n.reconnectState.active=!1,n.reconnectState.manualCancel=!0),dn(e),p(e,`Closed`,null,`Reconnection canceled by user`),n.term&&n.term.write(`\r
\x1B[1;90m● Reconnection canceled by user.\x1B[0m\r
\r
`),S(`Reconnection canceled`,`info`))}function gn(e,n=!1){let r=t[e];if(!r||r.isLocal)return;dn(e),r.reconnectState&&(r.reconnectState.timerId&&clearTimeout(r.reconnectState.timerId),r.reconnectState.countdownTimerId&&clearInterval(r.reconnectState.countdownTimerId));let i=r.profile;r.reconnectState={active:!0,attempt:1,maxAttempts:i.reconnectAttempts||W.reconnectAttempts||5,initialDelay:i.reconnectDelay||W.reconnectDelay||2,timerId:null,countdownTimerId:null,secondsRemaining:0,manualCancel:!1},_n(e,1,n)}function _n(e,n,r=!1){let i=t[e];if(!i||!i.reconnectState||!i.reconnectState.active)return;let{maxAttempts:a,initialDelay:o}=i.reconnectState;i.reconnectState.attempt=n;let s=0;if(s=r&&n===1?0:Math.min(60,Math.round(o*2**(n-1))),s<=0){vn(e,n);return}i.reconnectState.secondsRemaining=s,p(e,`Reconnecting`,null,`Reconnecting to ${i.profile.host} (Attempt ${n}/${a} in ${s}s)...`),i.term&&i.term.write(`\r\n\x1b[1;33m● [Attempt ${n}/${a}] Reconnecting in ${s}s... (Press Esc or click Cancel to stop)\x1b[0m\r\n`),pn(e,n,a,s),i.reconnectState.countdownTimerId=setInterval(()=>{if(!i.reconnectState||!i.reconnectState.active){clearInterval(i.reconnectState?.countdownTimerId);return}--i.reconnectState.secondsRemaining;let t=i.reconnectState.secondsRemaining;if(t>0){pn(e,n,a,t);let r=document.getElementById(`statusMessage`);r&&F()===e&&(r.textContent=`● Reconnecting to ${i.profile.host} (Attempt ${n}/${a} in ${t}s)...`)}else clearInterval(i.reconnectState.countdownTimerId)},1e3),i.reconnectState.timerId=setTimeout(()=>{clearInterval(i.reconnectState?.countdownTimerId),vn(e,n)},s*1e3)}async function vn(e,n){let r=t[e];if(!r||!r.reconnectState||!r.reconnectState.active)return;let{maxAttempts:i}=r.reconnectState,a=r.profile;p(e,`Reconnecting`,null,`Connecting to ${a.host} (Attempt ${n}/${i})...`),r.term&&r.term.write(`\x1b[1;36m● [Attempt ${n}/${i}] Connecting to ${a.host}:${a.port||22}...\x1b[0m\r\n`);let o=``,s=a.vaultKey||a.id;if(!a.privateKeyPath&&window.go&&window.go.main&&window.go.main.App)try{s&&typeof window.go.main.App.GetSessionPassword==`function`?o=await window.go.main.App.GetSessionPassword(s):s&&typeof window.go.main.App.GetSavedPassword==`function`&&(o=await window.go.main.App.GetSavedPassword(s)),!o&&window.go.main.App.FindSessionPassword&&a.host&&a.username&&(o=await window.go.main.App.FindSessionPassword(s||``,a.host,a.port||22,a.username))}catch{}try{window.go&&window.go.main&&window.go.main.App&&(typeof window.go.main.App.OpenSessionWithTabID==`function`?await window.go.main.App.OpenSessionWithTabID(e,a,o):await window.go.main.App.OpenSession(a,o)),r.reconnectState&&(r.reconnectState.timerId&&clearTimeout(r.reconnectState.timerId),r.reconnectState.countdownTimerId&&clearInterval(r.reconnectState.countdownTimerId),r.reconnectState.active=!1),dn(e),p(e,`Connected`),r.term&&r.term.write(`\r\n\x1b[1;32m✔ [Attempt ${n}/${i}] Successfully reconnected to ${a.host}!\x1b[0m\r\n\r\n`),S(`Reconnected to ${a.name}`,`success`)}catch(t){if(!r.reconnectState||!r.reconnectState.active)return;let o=ue(t);if(n<i){let t=Math.min(60,Math.round(r.reconnectState.initialDelay*2**n));r.term&&r.term.write(`\x1b[1;31m✖ [Attempt ${n}/${i}] Connection failed: [${o.category}] ${o.message}. Next retry in ${t}s...\x1b[0m\r\n`),_n(e,n+1,!1)}else r.reconnectState.active=!1,p(e,`Failed`,o),r.term&&(r.term.write(`\r\n\x1b[1;31m✖ Reconnection failed after ${i} attempts.\x1b[0m\r\n`),L(r.term,a,o)),mn(e,i),S(`Reconnection failed after ${i} attempts: [${o.category}]`,`error`)}}var yn=new Set;function bn(e){return yn.add(e),()=>yn.delete(e)}function xn(e,t){for(let n of yn)try{n(e,t)}catch(e){console.error(`multiExecData error:`,e)}}var Sn=RegExp(`[\\u001b\\u009b][[\\]()#;?]*(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[0-9A-ORZcf-nqry=><]`,`g`);function Cn(e){try{return String(e).replace(Sn,``).replace(/\r/g,``)}catch{return e}}function wn(){try{return localStorage.getItem(`nexterm_autolog`)===`1`}catch{return!1}}function Tn(e){try{localStorage.setItem(`nexterm_autolog`,e?`1`:`0`)}catch{}}function En(e){return e&&(e.customTitle||e.remoteHostname||e.profile?.name||e.profile?.host)||`session`}function Dn(e,n){let r=t[e];if(r&&r.logging&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.AppendSessionLog)try{window.go.main.App.AppendSessionLog(e,En(r),Cn(n))}catch{}}async function On(e){let n=t[e];if(!n){S(`Open a terminal first`,`warning`);return}if(n.logging){n.logging=!1;let t=``;if(window.go&&window.go.main&&window.go.main.App&&window.go.main.App.StopSessionLog)try{t=await window.go.main.App.StopSessionLog(e)}catch{}S(t?`Logging stopped — saved to ${t}`:`Session logging stopped`,`info`)}else n.logging=!0,S(`Session logging started — auto-saving transcript to the Nexterm Logs folder`,`success`)}function kn(){let e=document.getElementById(`multiExecBar`),t=document.getElementById(`multiExecInput`);e&&!e.classList.toggle(`hidden`)&&t&&(t.focus(),S(`MultiExec enabled: Commands will broadcast to all tabs`,`info`))}async function An(){let e=document.getElementById(`multiExecInput`);if(!e)return;let n=e.value;n&&(window.go&&window.go.main&&window.go.main.App?await window.go.main.App.BroadcastCommand([],n,`parallel`):Object.values(t).forEach(e=>e.term.write(n+`\r
`)),e.value=``,S(`Broadcast sent to all active tabs`,`success`))}function jn(e){let t=document.getElementById(`workspace`);if(!t)return;let n=e?r(e.environment||e.profile?.environment||e.color||e.profile?.color):null,i=n?n.color:``;if(n&&n.key===`prod`&&i){t.style.borderTop=`3px solid ${i}`,t.style.boxShadow=`inset 0 0 0 1px ${i}44`;let r=document.getElementById(`envGuardBadge`);r||(r=document.createElement(`div`),r.id=`envGuardBadge`,r.className=`env-guard-badge`,t.appendChild(r));let a=e.profile?.host||``;r.textContent=`${n.label}${a?` · `+a:``}`,r.style.background=n.bg||i,r.style.color=i,r.style.borderColor=i,r.hidden=!1}else Mn()}function Mn(){let e=document.getElementById(`workspace`);e&&(e.style.borderTop=``,e.style.boxShadow=``);let t=document.getElementById(`envGuardBadge`);t&&(t.hidden=!0)}function Nn(){Mn(),s(`home`);let e=document.getElementById(`homeTabBtn`),n=document.getElementById(`welcomeState`);e&&e.classList.add(`active`),n&&n.classList.add(`active`),Object.values(t).forEach(e=>{e.tabEl&&e.tabEl.classList.remove(`active`),e.paneEl&&e.paneEl.classList.remove(`active`)});let r=document.getElementById(`welcomeSearchInput`);r&&typeof r.focus==`function`&&setTimeout(()=>{try{r.focus()}catch{}},50),te()}function Pn(e){if(e===`home`){Nn();return}let n=document.getElementById(`homeTabBtn`),r=document.getElementById(`welcomeState`);n&&n.classList.remove(`active`),r&&r.classList.remove(`active`),s(e),u(e,!1);let i=x.panes.find(t=>t.tabIds&&t.tabIds.includes(e));i&&(i.activeTabId=e,x.activePaneId=i.id),Object.entries(t).forEach(([t,n])=>{let r=t===e;n.tabEl&&n.tabEl.classList.toggle(`active`,r)}),A();let a=t[e];if(jn(a),a){setTimeout(()=>{try{a.fitAddon&&a.fitAddon.fit(),a.term.focus(),window.go&&window.go.main&&window.go.main.App&&window.go.main.App.ResizeTerminal(e,a.term.cols||120,a.term.rows||30)}catch{}},40);let t=document.getElementById(`sftpActiveTabBadge`);if(a.isLocal)t&&(t.textContent=`Local Terminal`);else{let n=a.serialNo?`[${a.serialNo}] `:``,r=a.remoteHostname||(a.profile?.name&&a.profile.name!==`New Server`&&a.profile.name!==`New Session`?a.profile.name:a.profile?.host?a.profile.username?`${a.profile.username}@${a.profile.host}`:a.profile.host:`Server`);t&&(t.textContent=`${n}${r}`),ge()?xe(e):a.sftpPath||a.profile&&a.profile.initialDir}}te()}function Fn(e){let n=t[e];if(!n)return;if(n.logging&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.StopSessionLog){try{window.go.main.App.StopSessionLog(e)}catch{}n.logging=!1}if(n.reconnectState&&(n.reconnectState.timerId&&clearTimeout(n.reconnectState.timerId),n.reconnectState.countdownTimerId&&clearInterval(n.reconnectState.countdownTimerId),n.reconnectState.active=!1),dn(e),n.unsubscribers&&Array.isArray(n.unsubscribers)&&(n.unsubscribers.forEach(e=>{try{typeof e==`function`&&e()}catch{}}),n.unsubscribers=[]),window.runtime&&window.runtime.EventsOff){try{window.runtime.EventsOff(`terminal:data:`+e)}catch{}try{window.runtime.EventsOff(`terminal:state:`+e)}catch{}try{window.runtime.EventsOff(`terminal:closed:`+e)}catch{}}window.go&&window.go.main&&window.go.main.App&&window.go.main.App.CloseTab(e);let r=x.panes.find(t=>t.tabIds&&t.tabIds.includes(e));if(r){let t=r.tabIds.indexOf(e);t!==-1&&r.tabIds.splice(t,1),r.activeTabId===e&&(r.activeTabId=r.tabIds.length>0?r.tabIds[r.tabIds.length-1]:null)}if(n.searchAddon&&typeof n.searchAddon.dispose==`function`)try{n.searchAddon.dispose()}catch{}try{n.term.dispose()}catch{}n.tabEl&&n.tabEl.remove(),n.paneEl&&n.paneEl.remove(),m(e),f(),A();let i=Object.keys(t);i.length>0?r&&r.activeTabId?Pn(r.activeTabId):Pn(i[i.length-1]):Nn(),te()}function In(e){if(!e)return null;for(let[n,r]of Object.entries(t))if(r.profile&&(r.profile.id===e||r.profile.sessionId===e))return n;return null}function Ln(e){if(e&&t[e]){let n=t[e];if(n.isLocal)zn(`powershell`);else if(n.profile){let e={...n.profile,id:`dup-`+Date.now()+`-`+Math.random().toString(36).substr(2,6),sessionId:n.profile.id,vaultKey:n.profile.vaultKey||n.profile.id,name:n.profile.name||n.profile.host};V(e,!0),S(`Duplicating tab for "${e.name}"...`,`info`)}}}function Rn(e,n,i=!1,a=`Connected`){let o=document.getElementById(`welcomeState`),s=document.getElementById(`homeTabBtn`),c=document.getElementById(`tabbar`);o&&o.classList.remove(`active`),s&&s.classList.remove(`active`);let l=i?`state-connected`:a===`Connecting`?`state-connecting`:`state-connected`,d=i?`● Connected`:a===`Connecting`?`● Connecting...`:`● Connected`,m=r(n.environment||n.color),h=m?`<span class="tab-env-badge env-${m.key}" style="color:${m.color}; background:${m.bg}; border-color:${m.border};" title="Environment: ${m.name}">${m.label}</span>`:``,g=(c?c.querySelectorAll(`.tab-item:not(.home-tab)`):[]).length+1,_=n.name&&n.name!==`New Server`&&n.name!==`New Session`?n.name:n.host?n.username?`${n.username}@${n.host}`:n.host:i?`Local Terminal`:`Terminal`,v=`[${g}] ${_}`,y=document.createElement(`div`);y.className=`tab-item active`,y.dataset.tabId=e,y.title=`${v} (${d})${m?` [${m.name}]`:``}`,y.innerHTML=`
  ...
  `,y.addEventListener(`click`,()=>Pn(e)),y.addEventListener(`contextmenu`,t=>{t.preventDefault(),t.stopPropagation(),Bn(t.clientX,t.clientY,e)});let b=y.querySelector(`.tab-dropdown-btn`);b&&b.addEventListener(`click`,t=>{t.stopPropagation();let n=b.getBoundingClientRect();Bn(n.left,n.bottom+4,e)}),y.querySelector(`.tab-close`).addEventListener(`click`,t=>{t.stopPropagation(),Fn(e)}),c&&c.appendChild(y);let x=document.createElement(`div`);x.className=`terminal-pane active`,x.dataset.tabId=e;let S=x;i||(x.innerHTML=`
...
`){let n=D.trim();D=``,Ce(e,n);try{Et(e,n)}catch{}try{zt(t[e]&&t[e].profile?t[e].profile.host:``,n)}catch{}}else i===``||i===`\b`?D=D.slice(0,-1):i===``||i===``?D=``:i>=` `&&i<=`~`&&(D+=i)}}),C.onTitleChange(t=>{t&&!i&&we(e,t)});try{C.parser&&typeof C.parser.registerOscHandler==`function`&&C.parser.registerOscHandler(7,t=>(i||Te(e,t),!0))}catch{}let k=[];if(window.runtime&&window.runtime.EventsOn){let r=window.runtime.EventsOn(`terminal:data:`+e,t=>{C.write(t),xn(e,t),Dn(e,t),i||(O=(O+t).slice(-500),Ee(e,O)),F()!==e&&u(e,!0)});typeof r==`function`&&k.push(r),C.onBell&&C.onBell(()=>{F()!==e&&u(e,!0)});let a=window.runtime.EventsOn(`terminal:state:`+e,r=>{if(!r)return;let i=r.state,a=r.message||``,o=r.error?ue(r.error):null;p(e,i,o,a),i===`Connecting`?C.write(`\r\n\x1b[1;36m● Connecting to ${n.username||`user`}@${n.host}:${n.port||22}...\x1b[0m\r\n`):i===`Authenticating`?C.write(`\x1b[1;33m● Authenticating user '${n.username}'...\x1b[0m\r\n`):i===`Connected`?(C.write(`\x1b[1;32m● Connected to ${n.host}\x1b[0m\r\n\r\n`),t[e]&&t[e].sftpPath||n&&n.initialDir):i===`Failed`&&L(C,n,o)});typeof a==`function`&&k.push(a);let o=window.runtime.EventsOn(`terminal:closed:`+e,r=>{let a=`Disconnected`,o=null;typeof r==`object`&&r?(a=r.reason||`Disconnected`,o={category:r.category||`Server closed connection`,message:r.reason||`Session closed`,description:r.description||`The remote server or network closed the connection.`,rawError:r.rawError||r.reason||``}):typeof r==`string`&&(a=r,o=ue(r)),p(e,`Closed`,o,a),C.write(`\r\n\x1b[1;31m[● Connection lost: ${o.category} - ${o.message}]\x1b[0m\r\n`),L(C,n,o),!i&&t[e]&&((n.autoReconnect===void 0?W.autoReconnect:n.autoReconnect)?gn(e,!1):(fn(e,n,o),C.write(`\x1b[1;33m● Connection lost to ${n.host}. Press \x1b[1;36m[Enter]\x1b[1;33m or \x1b[1;36m[Y]\x1b[1;33m to reconnect, or \x1b[1;36m[N]\x1b[1;33m to dismiss.\x1b[0m\r\n\r\n`),t[e].awaitingReconnectPrompt=!0))});typeof o==`function`&&k.push(o)}C.onKey(n=>{let r=t[e];if(r){if(r.awaitingReconnectPrompt){if(n.key===`\r`||n.key.toLowerCase()===`y`){r.awaitingReconnectPrompt=!1,dn(e),gn(e,!0);return}if(n.key.toLowerCase()===`n`||n.domEvent&&n.domEvent.key===`Escape`){r.awaitingReconnectPrompt=!1,dn(e),C.write(`\r
\x1B[90m● Reconnection dismissed.\x1B[0m\r
`);return}}if(r.reconnectState&&r.reconnectState.active&&n.domEvent&&n.domEvent.key===`Escape`){hn(e);return}}}),x.addEventListener(`contextmenu`,async t=>{if(t.preventDefault(),t.stopPropagation(),W.rightClickPaste!==!1)try{let t=await navigator.clipboard.readText();t&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.WriteToTerminal(e,t)}catch(e){console.warn(`Clipboard paste error:`,e)}}),x.addEventListener(`auxclick`,async t=>{if(t.button===1){t.preventDefault();try{let t=await navigator.clipboard.readText();t&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.WriteToTerminal(e,t)}catch{}}}),C.onSelectionChange(()=>{if(W.autoCopySelection!==!1){let e=C.getSelection();e&&e.length>0&&navigator.clipboard.writeText(e).catch(()=>{})}}),x.addEventListener(`dragover`,e=>{e.preventDefault(),e.stopPropagation(),e.dataTransfer.dropEffect=`copy`}),x.addEventListener(`drop`,async t=>{if(t.preventDefault(),t.stopPropagation(),t.dataTransfer.files&&t.dataTransfer.files.length>0){let n=[];for(let e=0;e<t.dataTransfer.files.length;e++){let r=t.dataTransfer.files[e],i=r.path||r.name;n.push(i.includes(` `)?`"${i}"`:i)}let r=n.join(` `)+` `;window.go&&window.go.main&&window.go.main.App&&window.go.main.App.WriteToTerminal(e,r)}else{let n=t.dataTransfer.getData(`text`);n&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.WriteToTerminal(e,n)}});let M=P();M.tabIds.includes(e)||M.tabIds.push(e),M.activeTabId=e,t[e]={id:e,title:n?.name||(i?`Local Terminal`:`SSH Session`),host:n?.host||(i?`Local Shell`:`127.0.0.1`),term:C,fitAddon:w,searchAddon:T,searchState:E,profile:n,paneEl:x,tabEl:y,paneId:M.id,isConnected:a===`Connected`||i,connectionState:i?`Connected`:a,stateMessage:``,errorInfo:null,isLocal:i,sftpPath:n.initialDir||`~`,terminalCwd:n.initialDir||`~`,lastSftpPath:`~`,unsubscribers:k,reconnectState:null,awaitingReconnectPrompt:!1,color:n.color||``,environment:n.environment||``,pinned:!1,customTitle:``},A(),f(),ne(e),Pn(e)}async function zn(e=`powershell`){S(`Launching local terminal...`,`info`);let t;try{t=window.go&&window.go.main&&window.go.main.App?await window.go.main.App.OpenLocalTerminal(e):`mock-local-`+Date.now()}catch(e){S(`Failed to start local terminal: `+e,`error`);return}Rn(t,{id:t,name:e===`powershell`?`PowerShell`:`Command Prompt`,host:`localhost`,username:`Local`},!0),S(`Local terminal started`,`success`)}async function V(e,n=!1){if(!e)return;let r=P(),i=e.id&&r&&r.tabIds&&r.tabIds.some(n=>{let r=t[n];return r&&r.profile&&(r.profile.id===e.id||r.profile.sessionId===e.id)});if(!n&&e.id){let n=In(e.id);if(n&&t[n]){let r=t[n];if((r.isConnected||r.connectionState===`Connecting`||r.connectionState===`Authenticating`)&&(x.layout===`single`||i)){Pn(n),S(`Focused active connection for "${e.name||e.host}"`,`info`);return}}}let a=e.password||e.tempPassword||``,o=e.authType||(e.privateKeyPath?`key`:`password`),s=e.vaultKey||e.id;if(o===`password`){if(!a){let t=!1;if(window.go&&window.go.main&&window.go.main.App)try{if(s&&(t=await window.go.main.App.HasSavedPassword(s),t&&(typeof window.go.main.App.GetSessionPassword==`function`?a=await window.go.main.App.GetSessionPassword(s):typeof window.go.main.App.GetSavedPassword==`function`&&(a=await window.go.main.App.GetSavedPassword(s)))),!a&&window.go.main.App.FindSessionPassword&&e.host&&e.username){let n=await window.go.main.App.FindSessionPassword(s||``,e.host,e.port||22,e.username);n&&(a=n,t=!0)}}catch{}if((!t||!a)&&(a=await Jn(e),a===null))return}}else if(o===`key`){if(e.privateKeyPath&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.ValidatePrivateKeyFile){let t=!1,n=e.passphraseVaultKey||(e.vaultKey?e.vaultKey+`_passphrase`:``);if(n&&window.go.main.App.GetSessionPassphrase)try{await window.go.main.App.GetSessionPassphrase(n)&&(t=!0)}catch{}if(!t&&!e.keyPassphrase)try{let t=await window.go.main.App.ValidatePrivateKeyFile(e.privateKeyPath,``);if(t&&t.encrypted){let t=await Yn(e);if(t===null)return;e.keyPassphrase=t}}catch{}}}else if(o===`agent`&&window.go&&window.go.main&&window.go.main.App&&window.go.main.App.CheckSSHAgent)try{let e=await window.go.main.App.CheckSSHAgent();e&&!e.available&&S(`Warning: SSH Agent not active (${e.error||`service not running`})`,`warning`)}catch{}let c=``;if(e.useJumpHost&&e.jumpHost){let t=e.jumpAuthType||`password`,n=`${e.jumpUsername||`bastion`}@${e.jumpHost}:${e.jumpPort||22}`;if(t===`key`){if(e.jumpVaultKey&&window.go?.main?.App?.GetSessionPassphrase)try{c=await window.go.main.App.GetSessionPassphrase(e.jumpVaultKey+`_passphrase`)||``}catch{}if(!c&&e.jumpPrivateKeyPath&&window.go?.main?.App?.ValidatePrivateKeyFile)try{let t=await window.go.main.App.ValidatePrivateKeyFile(e.jumpPrivateKeyPath,``);if(t&&t.encrypted){let t=await Xn({gatewayLabel:n,vaultKey:e.jumpVaultKey,isKey:!0,keyPath:e.jumpPrivateKeyPath});if(t===null)return;c=t}}catch{}}else{if(e.jumpVaultKey&&window.go?.main?.App?.HasSavedPassword)try{await window.go.main.App.HasSavedPassword(e.jumpVaultKey)&&window.go.main.App.GetSessionPassword&&(c=await window.go.main.App.GetSessionPassword(e.jumpVaultKey)||``)}catch{}if(!c){let t=await Xn({gatewayLabel:n,vaultKey:e.jumpVaultKey,isKey:!1});if(t===null)return;c=t}}}let l=!n&&e.id&&In(e.id)||null;l&&t[l]?(t[l].profile=e,p(l,`Connecting`,null,`Connecting to ${e.host}...`),Pn(l),t[l].term&&t[l].term.reset()):(l=`ssh-`+Math.random().toString(36).substring(2,9)+`-`+Date.now().toString(36),Rn(l,e,!1,`Connecting`)),S(`Connecting to ${e.username}@${e.host}...`,`info`),p(l,`Connecting`,null,`Connecting to ${e.host}...`);try{if(window.go&&window.go.main&&window.go.main.App){if(typeof window.go.main.App.OpenSessionWithTabIDAndJumpSecret==`function`)await window.go.main.App.OpenSessionWithTabIDAndJumpSecret(l,e,a,c);else if(typeof window.go.main.App.OpenSessionWithTabID==`function`)await window.go.main.App.OpenSessionWithTabID(l,e,a);else{let n=await window.go.main.App.OpenSession(e,a);n&&n!==l&&t[l]&&(t[n]=t[l],m(l))}}else await new Promise(e=>setTimeout(e,300)),t[l]&&t[l].term&&(t[l].term.write(`\r\n\x1b[1;32m● Connected to ${e.host||`192.168.1.7`}\x1b[0m\r\n\r\n`),t[l].term.write(`Last login: ${new Date().toLocaleString()} from 192.168.1.108\r\n`),t[l].term.write(`\x1b[1;32m[${e.username||`pin`}@${(e.host||`SRV-01`).split(`.`)[0]} ~]$\x1b[0m `));p(l,`Connected`),wn()&&t[l]&&(t[l].logging=!0),S(`Connected to ${e.name||e.host}`,`success`);try{$t(l,e)}catch{}t[l]&&t[l].sftpPath||e&&e.initialDir}catch(n){let r=ue(n);p(l,`Failed`,r),t[l]&&t[l].term&&L(t[l].term,e,r),S(`Connection failed: [${r.category}] ${r.message}`,`error`)}}function Bn(e,n,r){let i=ke();if(!i)return;let a=t[r];if(!a)return;let o=l(r),s=Object.keys(t),c=s.indexOf(r),u=c>0,d=c!==-1&&c<s.length-1;i.innerHTML=`
  ...
  `,Ae(e,n);let f=i.querySelector(`#tabCtxRename`);f&&(f.onclick=()=>{R();let e=a.customTitle||a.profile?.name||`Terminal`,t=prompt(`Enter new tab name:`,e);t!==null&&t.trim()&&(ie(r,t.trim()),S(`Tab renamed to "${t.trim()}"`,`success`))});let p=i.querySelector(`#tabCtxColor`);p&&(p.onclick=t=>{t.stopPropagation(),Vn(e+180,n+20,r)});let m=i.querySelector(`#tabCtxDup`);m&&(m.onclick=()=>{R(),Ln(r)});let h=i.querySelector(`#tabCtxBroadcast`);h&&(h.onclick=()=>{R(),Xe(`selected`,[r])});let _=i.querySelector(`#tabCtxClose`);_&&(_.onclick=()=>{R(),Fn(r)});let v=i.querySelector(`#tabCtxCloseLeft`);v&&u&&(v.onclick=()=>{R(),s.slice(0,c).forEach(e=>{l(e)||Fn(e)}),S(`Closed tabs to the left`,`info`)});let y=i.querySelector(`#tabCtxCloseRight`);y&&d&&(y.onclick=()=>{R(),s.slice(c+1).forEach(e=>{l(e)||Fn(e)}),S(`Closed tabs to the right`,`info`)});let b=i.querySelector(`#tabCtxCloseOther`);b&&(b.onclick=()=>{R(),s.forEach(e=>{e!==r&&!l(e)&&Fn(e)}),S(`Closed other tabs`,`info`)});let C=i.querySelector(`#tabCtxCloseAll`);C&&(C.onclick=()=>{R(),s.forEach(e=>{l(e)||Fn(e)}),Nn(),S(`Closed all tabs`,`info`)});let w=i.querySelector(`#tabCtxSplit`);w&&(w.onclick=async()=>{R();let e=await on(()=>import(`./workspaceState-Av5XbUcK.js`).then(e=>e.f),[]),t=a.paneId||e.getWorkspaceState().activePaneId;e.splitPane(t,`right`);let n=e.getWorkspaceState(),i=n.panes.find(e=>e.id!==t)||n.panes[n.panes.length-1];i&&(e.moveTabToPane(r,i.id),e.setActiveWorkspacePane(i.id)),S(`Tab detached into split pane`,`success`)});let T=i.querySelector(`#tabCtxFullscreen`);T&&(T.onclick=()=>{R();let e=a.paneId||x.activePaneId;ee(e)});let E=i.querySelector(`#tabCtxPin`);E&&(E.onclick=()=>{R();let e=g(r);S(e?`Tab pinned 📌 (protected from bulk close)`:`Tab unpinned`,`info`)});let D=i.querySelector(`#tabCtxSave`);D&&(D.onclick=()=>{if(R(),!a.term)return;let e=a.term.buffer.active,t=[];for(let n=0;n<e.length;n++){let r=e.getLine(n);r&&t.push(r.translateToString(!0))}let n=t.join(`
...
`).trimEnd(),r=window.open(``,`_blank`);r&&(r.document.write(`<title>${j(a.profile?.name||`Terminal Output`)}</title><pre style="font-family: Consolas, monospace; font-size: 11px; white-space: pre-wrap; line-height: 1.4; padding: 16px;">${j(n)}</pre>`),r.document.close(),r.focus(),r.print())});let k=i.querySelector(`#tabCtxFontPlus`);k&&(k.onclick=()=>{if(R(),a.term){let e=a.term.options.fontSize||13;e<36&&(a.term.options.fontSize=e+1,a.fitAddon&&a.fitAddon.fit(),S(`Terminal font: ${a.term.options.fontSize}px`,`info`))}});let A=i.querySelector(`#tabCtxFontMinus`);A&&(A.onclick=()=>{if(R(),a.term){let e=a.term.options.fontSize||13;e>8&&(a.term.options.fontSize=e-1,a.fitAddon&&a.fitAddon.fit(),S(`Terminal font: ${a.term.options.fontSize}px`,`info`))}});let M=i.querySelector(`#tabCtxClear`);M&&(M.onclick=()=>{R(),a.term&&a.term.clear(),S(`Terminal screen cleared`,`info`)})}function Vn(e,n,i){let a=document.getElementById(`tabColorPopover`);a||(a=document.createElement(`div`),a.id=`tabColorPopover`,a.className=`tab-color-popover`,document.body.appendChild(a));let o=t[i];if(!o)return;let s=o.environment||o.profile?.environment||``,l=o.color||o.profile?.color||``;a.innerHTML=`
...
`);navigator.clipboard.writeText(n),S(`Copied outputs from ${t.length} servers`,`success`)},c.onclick=m,s.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),m())},l.onclick=()=>{Kn&&=(Kn(),null),U()},f(),setTimeout(()=>s.focus(),50)}function H(e,t=``){let n=document.getElementById(`modalOverlay`),r=document.getElementById(`modalBox`);return!n||!r?null:(r.className=`modal-card `+t,r.innerHTML=e,n.classList.remove(`hidden`),r)}function U(){let e=document.getElementById(`modalOverlay`),t=document.getElementById(`modalBox`);e&&e.classList.add(`hidden`),t&&(t.innerHTML=``)}function Jn(e){return new Promise(t=>{let n=H(`
  ...
  `,`modal-hostkey`);if(!c)return;let l=document.getElementById(`modalOverlay`);l&&(l.onclick=e=>{e.target===l&&r(`reject`)});let u=c.querySelector(`#modalClose`);if(u&&(u.onclick=()=>r(`reject`)),c.querySelectorAll(`.btn-copy-fp`).forEach(e=>{e.onclick=()=>{let t=e.dataset.copy;t&&navigator.clipboard&&navigator.clipboard.writeText(t).then(()=>{S(`Fingerprint copied to clipboard`,`success`)}).catch(()=>{S(`Failed to copy`,`error`)})}}),t){let t=c.querySelector(`#btnHkAbort`);t&&(t.onclick=()=>r(`reject`));let n=c.querySelector(`#btnHkOverride`);n&&(n.onclick=()=>{confirm(`Are you absolutely sure you want to replace the host key for ${e.host}:${e.port} in known_hosts? This will trust the new key.`)&&r(`accept_save`)})}else{let e=c.querySelector(`#btnHkReject`);e&&(e.onclick=()=>r(`reject`));let t=c.querySelector(`#btnHkOnce`);t&&(t.onclick=()=>r(`accept_once`));let n=c.querySelector(`#btnHkTrust`);n&&(n.onclick=()=>r(`accept_save`))}}async function $n(){let e=document.getElementById(`sidebarTunnelList`);if(e)try{let t=[];if(window.go&&window.go.main&&window.go.main.App&&(t=await window.go.main.App.GetTunnels()||[]),t.length===0){e.innerHTML=`<div class="sftp-empty-hint">No active SSH tunnels.<br/>Click <b>＋ New SSH Tunnel</b> to configure port forwarding.</div>`;return}e.innerHTML=t.map(e=>`
    ...
    `).join(``),e.querySelectorAll(`.start-tun-btn`).forEach(e=>{e.onclick=async()=>{let t=F();if(!t||t===`home`){S(`Please open an active SSH tab first to bind the tunnel`,`warning`);return}try{await window.go.main.App.StartTunnel(e.dataset.id,t),S(`SSH tunnel started`,`success`),await $n()}catch(e){S(`Failed to start tunnel: `+e,`error`)}}}),e.querySelectorAll(`.stop-tun-btn`).forEach(e=>{e.onclick=async()=>{try{await window.go.main.App.StopTunnel(e.dataset.id),S(`Tunnel stopped`,`info`),await $n()}catch(e){S(`Failed to stop tunnel: `+e,`error`)}}}),e.querySelectorAll(`.del-tun-btn`).forEach(e=>{e.onclick=async()=>{confirm(`Delete this tunnel definition?`)&&(await window.go.main.App.DeleteTunnel(e.dataset.id),await $n())}})}catch(t){e.innerHTML=`<div class="sftp-empty-hint" style="color: var(--accent-red);">${j(t.toString())}</div>`}}function er(){let e=H(`
    <div class="modal-header">
  ...
  `);e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#modalCloseBtn`).onclick=U,e.querySelector(`#newTunnelWizardBtn`).onclick=()=>{U(),tr()};let t=async()=>{let n=e.querySelector(`#modalTunnelList`);if(n)try{let e=await window.go.main.App.GetTunnels()||[];if(e.length===0){n.innerHTML=`<div class="pwd-empty-state">No active tunnels. Click <b>＋ New SSH Tunnel</b> to configure forwarding.</div>`;return}n.innerHTML=e.map(e=>`
      ...
      `).join(``),n.querySelectorAll(`.start-modal-tun`).forEach(e=>{e.onclick=async()=>{let n=F();if(!n||n===`home`){S(`Open an SSH tab first to bind tunnel`,`warning`);return}await window.go.main.App.StartTunnel(e.dataset.id,n),await t(),await $n()}}),n.querySelectorAll(`.stop-modal-tun`).forEach(e=>{e.onclick=async()=>{await window.go.main.App.StopTunnel(e.dataset.id),await t(),await $n()}}),n.querySelectorAll(`.del-modal-tun`).forEach(e=>{e.onclick=async()=>{confirm(`Delete tunnel?`)&&(await window.go.main.App.DeleteTunnel(e.dataset.id),await t(),await $n())}})}catch{}};t()}function tr(){let e=H(`
    <div class="modal-header">
  ...
  `),t=e.querySelector(`#tunType`);t.onchange=()=>{let n=t.value===`dynamic`;e.querySelector(`#tunRemotePortGroup`).classList.toggle(`hidden`,n),e.querySelector(`#tunRemoteHostGroup`).classList.toggle(`hidden`,n)},e.querySelector(`#modalCancel`).onclick=U,e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#saveTunnelBtn`).onclick=async()=>{let n={name:e.querySelector(`#tunName`).value.trim()||`SSH Tunnel`,type:t.value,localPort:parseInt(e.querySelector(`#tunLocalPort`).value,10)||8080,remotePort:parseInt(e.querySelector(`#tunRemotePort`).value,10)||80,remoteHost:e.querySelector(`#tunRemoteHost`).value.trim()||`127.0.0.1`,autoStart:!1};U(),window.go&&window.go.main&&window.go.main.App&&(await window.go.main.App.SaveTunnel(n),S(`SSH tunnel saved`,`success`),await $n())}}async function nr(){let e=document.getElementById(`macrosList`);if(e)try{let t=[];if(window.go&&window.go.main&&window.go.main.App&&(t=await window.go.main.App.GetMacros()||[]),t.length===0){e.innerHTML=`<div class="sftp-empty-hint">No command snippets found.<br/>Click <b>＋ New Snippet / Macro</b> to create one.</div>`;return}let n={};t.forEach(e=>{let t=e.category||`Commands`;n[t]||(n[t]=[]),n[t].push(e)}),e.innerHTML=Object.keys(n).sort((e,t)=>e.toLowerCase()===`commands`?-1:t.toLowerCase()===`commands`?1:e.localeCompare(t)).map(e=>{let t=n[e];return`
      ...
      `}).join(``),e.querySelectorAll(`.macro-category-header`).forEach(e=>{e.onclick=()=>{let t=e.closest(`.macro-category-group`).querySelector(`.macro-category-items`),n=e.querySelector(`.macro-category-chevron`);if(t){let e=t.style.display===`none`;t.style.display=e?`block`:`none`,n&&(n.textContent=e?`▾`:`▸`)}}}),e.querySelectorAll(`.run-macro-opt-btn`).forEach(e=>{e.onclick=n=>{n.stopPropagation();let r=t.find(t=>t.id===e.dataset.id);r&&ir(r)}}),e.querySelectorAll(`.quick-macro-btn`).forEach(e=>{e.onclick=t=>{t.stopPropagation(),rr(e.dataset.id)}}),e.querySelectorAll(`.edit-macro-btn`).forEach(e=>{e.onclick=n=>{n.stopPropagation();let r=t.find(t=>t.id===e.dataset.id);r&&ar(r)}}),e.querySelectorAll(`.del-macro-btn`).forEach(e=>{e.onclick=async n=>{n.stopPropagation();let r=t.find(t=>t.id===e.dataset.id),i=r?r.name:`snippet`;confirm(`Delete command snippet "${i}"?`)&&(await window.go.main.App.DeleteMacro(e.dataset.id),S(`Deleted snippet "${i}"`,`info`),await nr())}})}catch(t){e.innerHTML=`<div class="sftp-empty-hint" style="color: var(--accent-red);">${j(t.toString())}</div>`}}async function rr(e){let t=F();if(!t||t===`home`){S(`Please select an active terminal tab to run snippet`,`warning`);return}if(window.go&&window.go.main&&window.go.main.App)try{await window.go.main.App.ExecuteMacro(e,[t]),S(`Command snippet dispatched to active terminal`,`success`)}catch(e){S(`Snippet error: `+e,`error`)}}function ir(e){if(!e)return;let n=y&&t&&t[y],r=n?n.profile&&n.profile.name?n.profile.name:n.title||y:`No active terminal`,i=t?Object.entries(t).filter(([e,t])=>t&&!t.isHome):[],a=[];function o(e,t=``){if(!e)return;let n=t?`${t} / ${e.name}`:e.name;if(!e.session&&e.id!==(I?I.id:``)&&a.push({id:e.id,name:e.name,fullPath:n,node:e}),e.children)for(let t of e.children)t.session||o(t,n)}o(I);let s=H(`
    <div class="modal-header">
      <div class="modal-title" style="display:flex; align-items:center; gap:8px;">
        <span>⚡</span>
...
`).map(e=>e.trim()).filter(e=>e.length>0),a=parseInt(o.querySelector(`#macroDelay`)?.value,10)||500,s={id:t&&e.id?e.id:``,name:n,category:o.querySelector(`#macroCat`).value.trim()||`Commands`,description:i.slice(0,2).join(`; `),commands:i,delayMs:a};U(),window.go&&window.go.main&&window.go.main.App&&(await window.go.main.App.SaveMacro(s),S(t?`Snippet updated`:`Snippet saved`,`success`),await nr())}}function or(){let e=H(`
  ...
  `);e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#modalCloseBtn`).onclick=U,e.querySelector(`#doDNSBtn`).onclick=async()=>{let t=e.querySelector(`#dnsDomain`).value.trim(),n=e.querySelector(`#dnsOutput`);if(n.innerHTML=`Resolving DNS for ${t}...`,window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.NetLookupDNS(t);n.innerHTML=Object.entries(e).map(([e,t])=>`
        ...
        `).join(``)}catch(e){n.textContent=`DNS lookup error: `+e}}}function cr(){let e=H(`
    <div class="modal-header">
  ...
  `);e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#modalCloseBtn`).onclick=U}function ur(){let e=H(`
    <div class="modal-header">
  ...
  `);e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#modalCloseBtn`).onclick=U,e.querySelector(`#diffCompareBtn`).onclick=()=>{let t=e.querySelector(`#diffLeft`).value,n=e.querySelector(`#diffRight`).value,r=e.querySelector(`#diffOutput`);r.innerHTML=t===n?`<span style="color: var(--accent-green);">✓ Both texts are identical.</span>`:`<span style="color: var(--accent-yellow);">Differences detected (Left: ${t.length} chars, Right: ${n.length} chars).</span>`}}function dr(){let e=[];for(let t=32;t<=126;t++)e.push({dec:t,hex:t.toString(16).toUpperCase(),char:String.fromCharCode(t)});let t=H(`
    <div class="modal-header">
  ...
  `);t.querySelector(`#modalClose`).onclick=U,t.querySelector(`#modalCloseBtn`).onclick=U}function fr(){let e=H(`
    <div class="modal-header">
  ...
  `);e.querySelector(`#modalClose`).onclick=U,e.querySelector(`#modalCloseBtn`).onclick=U,e.querySelector(`#doScanBtn`).onclick=async()=>{let t=e.querySelector(`#scanHost`).value.trim(),n=e.querySelector(`#scanResults`);if(n.innerHTML=`Scanning ports on ${j(t)}...`,window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.NetPortScan(t,[21,22,23,25,53,80,110,143,443,1433,1521,3306,3389,5432,5900,6379,8080,8443,27017]);n.innerHTML=`<b>Scan Results for ${j(t)}:</b><br/>`+e.map(e=>`
    ...
    <div class="modal-body">
      ...
      <div class="theme-picker-grid" id="themePickerGrid">
        ${Object.entries(gr).map(([t,n])=>{let r=t===e,i=n.swatches.map(e=>`<span class="theme-swatch" style="background: ${e};"></span>`).join(``);return`
  ...
  `}function kr(){let e=document.getElementById(`monCloseBtn`);e&&(e.onclick=Dr);let t=document.getElementById(`monServerSelect`);t&&(t.onchange=()=>{G.tabId=t.value,G.prevNet=null,G.prevCpu=null,G.history={cpu:[],ram:[],net:[]},Mr()}),document.querySelectorAll(`.mon-tab`).forEach(e=>{e.onclick=()=>Ar(e.getAttribute(`data-view`))});let n=document.getElementById(`monSortCpu`),r=document.getElementById(`monSortMem`);n&&(n.onclick=()=>{G.procSort=`cpu`,jr(),Pr()}),r&&(r.onclick=()=>{G.procSort=`mem`,jr(),Pr()}),jr()}function Ar(e){G.view=e,document.querySelectorAll(`.mon-tab`).forEach(t=>t.classList.toggle(`active`,t.getAttribute(`data-view`)===e)),Object.entries({overview:`monViewOverview`,processes:`monViewProcesses`,services:`monViewServices`,docker:`monViewDocker`}).forEach(([t,n])=>{let r=document.getElementById(n);r&&(r.hidden=t!==e)}),e===`processes`?Pr():e===`services`?Ir():e===`docker`&&Rr()}function jr(){let e=document.getElementById(`monSortCpu`),t=document.getElementById(`monSortMem`);e&&e.classList.toggle(`active`,G.procSort===`cpu`),t&&t.classList.toggle(`active`,G.procSort===`mem`)}async function Mr(){if(!G.open||!G.tabId)return;if(!document.getElementById(`monCloseBtn`)){Dr();return}if(G.busy)return;G.busy=!0;let e=``;try{e=await window.go.main.App.RunSSHCommand(G.tabId,Cr)}catch{G.busy=!1,ii(`monHostName`,`(unreachable)`);return}if(G.busy=!1,G.open){try{let t=Ur(e);Kr(t),Nr(t)}catch(e){console.warn(`monitor parse error`,e)}Xr(),G.view===`processes`?Pr():G.view===`services`?Ir():G.view===`docker`&&Rr()}}function Nr(e){let t=Date.now(),n=(e,n)=>{t-(G.lastAlert[e]||0)>Sr&&(G.lastAlert[e]=t,S(`⚠️ `+n,`warning`))};e.cpuPct>=xr.cpu&&n(`cpu`,`High CPU on ${e.host||`server`}: ${Math.round(e.cpuPct)}%`),e.memPct>=xr.ram&&n(`ram`,`High memory on ${e.host||`server`}: ${Math.round(e.memPct)}%`),(e.disks||[]).forEach(t=>{let r=parseInt(t.pct,10)||0;r>=xr.disk&&n(`disk:`+t.mount,`Disk ${t.mount} on ${e.host||`server`} is ${r}% full`)})}async function Pr(){let e=document.getElementById(`monProcs`);if(!e)return;let t=`ps -eo pid,user,pcpu,pmem,comm --sort=${G.procSort===`mem`?`-pmem`:`-pcpu`} 2>/dev/null | head -n 31`,n=``;try{n=await window.go.main.App.RunSSHCommand(G.tabId,t)}catch{return}let r=n.split(`
`).map(e=>e.trim()).filter(Boolean);r.shift();let i=r.map(e=>{let t=e.split(/\s+/);return{pid:t[0],user:t[1],cpu:t[2],mem:t[3],cmd:t.slice(4).join(` `)}}).filter(e=>e.pid&&/^\d+$/.test(e.pid));if(ii(`monProcCount`,String(i.length)),!i.length){e.innerHTML=`<div class="mon-empty">No process data</div>`;return}e.innerHTML=`<div class="mon-row mon-row-hdr"><div class="mon-row-main">PID · User · Command</div><div class="mon-row-side">CPU / MEM</div></div>`+i.map(e=>`
      <div class="mon-row">
      ...
      </div>`).join(``),e.querySelectorAll(`[data-killproc]`).forEach(e=>{e.onclick=()=>Fr(e.getAttribute(`data-killproc`),e.getAttribute(`data-name`))})}async function Fr(e,t){if(e&&confirm(`Kill process ${e} (${t}) on this server?`))try{await window.go.main.App.RunSSHCommand(G.tabId,`kill -TERM ${e} 2>&1 || sudo kill -TERM ${e} 2>&1`),S(`Sent terminate to PID ${e}`,`info`),setTimeout(Pr,500)}catch(e){S(`Kill failed: `+e,`error`)}}async function Ir(){let e=document.getElementById(`monServices`);if(!e)return;let t=``;try{t=await window.go.main.App.RunSSHCommand(G.tabId,`systemctl list-units --type=service --all --no-legend --no-pager 2>/dev/null | head -n 60`)}catch{return}let n=t.split(`
`).map(e=>e.replace(/^\s*[●*]\s*/,``).trim()).filter(Boolean).map(e=>{let t=e.split(/\s+/);return{unit:t[0],load:t[1],active:t[2],sub:t[3],desc:t.slice(4).join(` `)}}).filter(e=>e.unit&&e.unit.endsWith(`.service`));if(ii(`monSvcCount`,String(n.length)),!n.length){e.innerHTML=`<div class="mon-empty">No services found (systemd may be unavailable)</div>`;return}e.innerHTML=n.map(e=>{let t=e.active===`active`;return`<div class="mon-row">
    ...
    </div>`}).join(``),e.querySelectorAll(`[data-svc]`).forEach(e=>{e.onclick=()=>Lr(e.getAttribute(`data-svc`),e.getAttribute(`data-op`))})}async function Lr(e,t){if(e&&t&&confirm(`${t} service "${e}" on this server?`))try{await window.go.main.App.RunSSHCommand(G.tabId,`systemctl ${t} ${e} 2>&1 || sudo systemctl ${t} ${e} 2>&1`),S(`${t} sent to ${e}`,`info`),setTimeout(Ir,700)}catch(e){S(`Service action failed: `+e,`error`)}}async function Rr(){let e=document.getElementById(`monDocker`);if(!e)return;let t=``;try{t=await window.go.main.App.RunSSHCommand(G.tabId,`docker ps -a --format '{{.ID}}|{{.Names}}|{{.Image}}|{{.State}}|{{.Status}}' 2>&1 | head -n 60`)}catch{return}if(/command not found|permission denied|Cannot connect to the Docker daemon/i.test(t)){e.innerHTML=`<div class="mon-empty">Docker not available on this host (${K(t.split(`
`)[0]||``)})</div>`,ii(`monDockerCount`,`0`);return}let n=t.split(`
`).map(e=>e.trim()).filter(e=>e.includes(`|`)).map(e=>{let t=e.split(`|`);return{id:t[0],name:t[1],image:t[2],state:t[3],status:t[4]}});if(ii(`monDockerCount`,String(n.length)),!n.length){e.innerHTML=`<div class="mon-empty">No containers</div>`;return}e.innerHTML=n.map(e=>{let t=/running|up/i.test(e.state)||/^Up/i.test(e.status);return`<div class="mon-row">
    ...
    </div>`}).join(``),e.querySelectorAll(`[data-dockerrestart]`).forEach(e=>e.onclick=()=>zr(e.getAttribute(`data-dockerrestart`),`restart`,e.getAttribute(`data-name`))),e.querySelectorAll(`[data-dockerstop]`).forEach(e=>e.onclick=()=>zr(e.getAttribute(`data-dockerstop`),`stop`,e.getAttribute(`data-name`))),e.querySelectorAll(`[data-dockerlogs]`).forEach(e=>e.onclick=()=>Br(e.getAttribute(`data-dockerlogs`),e.getAttribute(`data-name`)))}async function zr(e,t,n){if(e&&(t!==`stop`||confirm(`Stop container ${n}?`)))try{await window.go.main.App.RunSSHCommand(G.tabId,`docker ${t} ${e} 2>&1 || sudo docker ${t} ${e} 2>&1`),S(`docker ${t} ${n}`,`info`),setTimeout(Rr,900)}catch(e){S(`Docker action failed: `+e,`error`)}}async function Br(e,t){try{let n=await window.go.main.App.RunSSHCommand(G.tabId,`docker logs --tail 200 ${e} 2>&1 || sudo docker logs --tail 200 ${e} 2>&1`);G.interval&&=(clearInterval(G.interval),null),G.open=!1,H(`
      <div class="broadcast-modal-card bcast-large-modal mon-modal">
        <div class="broadcast-header">
      ...
      </div>`,`modal-plain`);let r=document.getElementById(`monLogsClose`);r&&(r.onclick=()=>Vr(`docker`))}catch(e){S(`Could not fetch logs: `+e,`error`)}}function Vr(e){G.open=!0,H(Or(),`modal-plain`),kr(),Ar(e||`overview`),G.interval||=setInterval(Mr,G.intervalMs),Mr()}function Hr(e,t){let n=RegExp(`@@`+t+`@@\\n?([\\s\\S]*?)(?=@@[A-Z]+@@|$)`),r=e.match(n);return r?r[1].trim():``}function Ur(e){let t={};t.host=Hr(e,`HOST`).split(`
`)[0]||``,t.nproc=parseInt(Hr(e,`NPROC`),10)||1;let n=Hr(e,`UPTIME`);t.uptimeText=ti(n);let r=n.match(/load average[s]?:\s*([\d.]+),?\s*([\d.]+),?\s*([\d.]+)/i);t.load=r?[parseFloat(r[1]),parseFloat(r[2]),parseFloat(r[3])]:[0,0,0];let i=Hr(e,`STAT`).split(/\s+/).slice(1).map(Number).filter(e=>!isNaN(e));if(i.length>=4){let e=i[3]+(i[4]||0),n=i.reduce((e,t)=>e+t,0);if(G.prevCpu){let r=e-G.prevCpu.idle,i=n-G.prevCpu.total;t.cpuPct=i>0?Math.max(0,Math.min(100,(1-r/i)*100)):0}else t.cpuPct=Math.max(0,Math.min(100,t.load[0]/t.nproc*100));G.prevCpu={idle:e,total:n}}else t.cpuPct=Math.max(0,Math.min(100,t.load[0]/t.nproc*100));let a=Hr(e,`MEM`).split(`
`).find(e=>/^Mem:/i.test(e.trim()));if(a){let e=a.trim().split(/\s+/);t.memTotal=parseInt(e[1],10)||0,t.memUsed=parseInt(e[2],10)||0,t.memPct=t.memTotal?t.memUsed/t.memTotal*100:0}else t.memTotal=0,t.memUsed=0,t.memPct=0;return t.users=Hr(e,`WHO`).split(`
`).filter(Boolean).map(e=>{let t=e.trim().split(/\s+/);return{user:t[0]||``,tty:t[1]||``,since:t.slice(2,5).join(` `),from:(e.match(/\(([^)]+)\)/)||[])[1]||``}}).filter(e=>e.user),t.ports=Wr(Hr(e,`PORTS`)),t.net=Gr(Hr(e,`NET`)),t.disks=Hr(e,`DISK`).split(`
`).filter(Boolean).map(e=>{let t=e.trim().split(/\s+/);return{fs:t[0],size:t[1],used:t[2],avail:t[3],pct:t[4],mount:t[5]}}).filter(e=>e.mount&&e.fs&&!/^(tmpfs|devtmpfs|udev|overlay)$/.test(e.fs)),t}function Wr(e){let t=[];e.split(`
`).filter(Boolean).forEach(e=>{if(/^Netid|^Proto|^Active/i.test(e.trim()))return;let n=e.trim().split(/\s+/),r=n.find(e=>/:\d+$/.test(e))||``,i=(r.match(/:(\d+)$/)||[])[1]||``;if(!i)return;let a=n[0]&&/tcp|udp/i.test(n[0])?n[0].toLowerCase():e.includes(`tcp`)?`tcp`:`udp`,o=e.match(/pid=(\d+)/)||e.match(/,(\d+),/)||e.match(/\/(\d+)\//),s=e.match(/\(\("([^"]+)"/)||e.match(/\d+\/([\w.-]+)/);t.push({proto:a,port:i,pid:o?o[1]:``,proc:s?s[1]:``,addr:r})});let n=new Set;return t.filter(e=>{let t=e.proto+e.port;return!n.has(t)&&(n.add(t),!0)}).sort((e,t)=>parseInt(e.port)-parseInt(t.port))}function Gr(e){let t=0,n=0;e.split(`
`).forEach(e=>{let r=e.split(`:`);if(r.length<2)return;let i=r[0].trim();if(i===`lo`||!i)return;let a=r[1].trim().split(/\s+/).map(Number);a.length>=9&&(t+=a[0],n+=a[8])});let r=Date.now(),i=0,a=0;if(G.prevNet){let e=(r-G.prevNet.ts)/1e3;e>0&&(i=Math.max(0,(t-G.prevNet.rx)/e),a=Math.max(0,(n-G.prevNet.tx)/e))}return G.prevNet={ts:r,rx:t,tx:n},{rxRate:i,txRate:a}}function Kr(e){ii(`monHostName`,e.host?`· `+e.host:``),ii(`monCpuVal`,Math.round(e.cpuPct)+`%  (`+e.nproc+` cores)`),ii(`monRamVal`,e.memTotal?`${ni(e.memUsed)} / ${ni(e.memTotal)} (${Math.round(e.memPct)}%)`:`—`),ii(`monNetVal`,`↓ ${ri(e.net.rxRate)}   ↑ ${ri(e.net.txRate)}`),ii(`monUptimeVal`,e.uptimeText||`—`),ii(`monLoadAvg`,`load ${e.load.map(e=>e.toFixed(2)).join(`  `)}`),$r(`cpu`,e.cpuPct),$r(`ram`,e.memPct),$r(`net`,(e.net.rxRate+e.net.txRate)/1024),ei(`monCpuGraph`,G.history.cpu,`#38bdf8`,100),ei(`monRamGraph`,G.history.ram,`#a855f7`,100),ei(`monNetGraph`,G.history.net,`#22c55e`,null),qr(e.users),Jr(e.ports),Yr(e.disks)}function qr(e){G.lastUsers=e,ii(`monUserCount`,String(e.length));let t=document.getElementById(`monUsers`);if(t){if(!e.length){t.innerHTML=`<div class="mon-empty">No interactive users</div>`;return}t.innerHTML=e.map(e=>`
    <div class="mon-row">
    ...
    </div>`).join(``),t.querySelectorAll(`[data-kick]`).forEach(e=>{e.onclick=()=>Qr(e.getAttribute(`data-user`),e.getAttribute(`data-kick`))})}}function Jr(e){G.lastPorts=e,ii(`monPortCount`,String(e.length));let t=document.getElementById(`monPorts`);if(t){if(!e.length){t.innerHTML=`<div class="mon-empty">No listening ports detected (may need root)</div>`;return}t.innerHTML=e.map(e=>`
    <div class="mon-row">
    ...
    </div>`).join(``),t.querySelectorAll(`[data-killpid]`).forEach(e=>{e.onclick=()=>Zr(e.getAttribute(`data-killpid`),e.getAttribute(`data-port`))})}}function Yr(e){let t=document.getElementById(`monDisk`);if(t){if(!e||!e.length){t.innerHTML=`<div class="mon-empty">No disk data</div>`;return}t.innerHTML=e.map(e=>{let t=parseInt(e.pct,10)||0,n=t>=90?`#ef4444`:t>=75?`#f59e0b`:`#22c55e`;return`<div class="mon-row">
    ...
    </div>`}).join(``)}}function Xr(){let e=document.getElementById(`monLocalBar`);if(!e)return;let n=Object.entries(t).filter(([e])=>e!==`home`),r=n.filter(([,e])=>e&&e.isConnected),i=r.filter(([e])=>e!==y).length,a=``;try{if(performance&&performance.memory){let e=performance.memory.usedJSHeapSize/1048576,t=performance.memory.jsHeapSizeLimit/1048576;a=` · App memory: ${e.toFixed(0)} MB / ${t.toFixed(0)} MB`}}catch{}e.textContent=`Open tabs: ${n.length} · Connected: ${r.length} · Inactive (background) tabs: ${i}${a}`}async function Zr(e,t){if(e&&confirm(`Close port ${t} by terminating process PID ${e} on this server?\n\nThis can disrupt a running service. Continue?`))try{await window.go.main.App.RunSSHCommand(G.tabId,`kill -TERM ${e} 2>&1 || sudo kill -TERM ${e} 2>&1`),S(`Sent terminate to PID ${e} (port ${t})`,`info`),setTimeout(Mr,600)}catch(e){S(`Failed to close port: `+e,`error`)}}async function Qr(e,t){if(!t){S(`No TTY to disconnect`,`warning`);return}if(confirm(`Disconnect user "${e}" on ${t}?\n\nTheir session will be terminated. Continue?`))try{await window.go.main.App.RunSSHCommand(G.tabId,`pkill -9 -t ${t} 2>&1 || sudo pkill -9 -t ${t} 2>&1`),S(`Disconnected ${e} (${t})`,`info`),setTimeout(Mr,600)}catch(e){S(`Failed to disconnect user: `+e,`error`)}}function $r(e,t){let n=G.history[e];n.push(isFinite(t)?t:0),n.length>br&&n.shift()}function ei(e,t,n,r){let i=document.getElementById(e);if(!i||!i.getContext)return;let a=i.getContext(`2d`),o=i.width,s=i.height;if(a.clearRect(0,0,o,s),!t.length)return;let c=r??Math.max(1,...t),l=o/119;a.beginPath(),t.forEach((e,t)=>{let n=t*l,r=s-Math.min(e,c)/c*(s-4)-2;t===0?a.moveTo(n,r):a.lineTo(n,r)}),a.strokeStyle=n,a.lineWidth=1.6,a.stroke(),a.lineTo((t.length-1)*l,s),a.lineTo(0,s),a.closePath(),a.fillStyle=n+`22`,a.fill()}function ti(e){let t=e.match(/up\s+(.+?),\s+\d+\s+user/);return t?t[1].trim():(e.split(`,`)[0]||``).replace(/.*up/,`up`).trim()}function ni(e){return e>=1024?(e/1024).toFixed(1)+` GB`:e+` MB`}function ri(e){return e>=1048576?(e/1048576).toFixed(1)+` MB/s`:e>=1024?(e/1024).toFixed(1)+` KB/s`:Math.round(e)+` B/s`}function ii(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function K(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}var ai=`nexterm_session_groups`;function oi(){try{let e=localStorage.getItem(ai),t=e?JSON.parse(e):[];return Array.isArray(t)?t:[]}catch{return[]}}function si(e){try{localStorage.setItem(ai,JSON.stringify(e))}catch{}}function ci(e){let t=null;return(function n(r){if(r&&!t){if(r.session&&r.session.id===e){t=r.session;return}r.children&&r.children.forEach(n)}})(I),t}function li(){let e=new Set,n=[];return Object.values(t).forEach(t=>{t&&t.profile&&t.profile.id&&!t.isLocal&&!e.has(t.profile.id)&&(e.add(t.profile.id),n.push({id:t.profile.id,name:t.profile.name||t.profile.host||`Server`}))}),n}function ui(){let e=li();if(e.length===0){S(`No open server tabs to save. Connect to some servers first.`,`warning`);return}let t=prompt(`Save these ${e.length} open server(s) as a group named:`,`My Workspace`);if(!t||!t.trim())return;let n=oi(),r=n.findIndex(e=>e.name.toLowerCase()===t.trim().toLowerCase()),i={name:t.trim(),ids:e.map(e=>e.id),autoStart:r>=0&&n[r].autoStart};r>=0?n[r]=i:n.push(i),si(n),S(`Saved group "${i.name}" (${i.ids.length} servers)`,`success`)}async function di(e){let t=oi().find(t=>t.name===e);if(!t){S(`Group "${e}" not found`,`error`);return}let n=0,r=0;for(let e of t.ids){let t=ci(e);t?(V(t,!0),n++):r++}S(`Opening group "${e}": ${n} server(s)${r?`, ${r} no longer saved`:``}`,n?`success`:`warning`)}async function fi(){let e=oi().filter(e=>e.autoStart);for(let t of e)await di(t.name)}function pi(){e();function e(){let t=oi(),n=li().length;H(`
      <div class="modal-header">
    ...
    `,`modal-lg`);let r=document.getElementById(`grpClose`);r&&(r.onclick=U);let i=document.getElementById(`grpSaveCurrent`);i&&(i.onclick=()=>{ui(),e()}),document.querySelectorAll(`[data-open]`).forEach(e=>{e.onclick=()=>{let t=oi()[+e.getAttribute(`data-open`)];t&&(U(),di(t.name))}}),document.querySelectorAll(`[data-del]`).forEach(t=>{t.onclick=()=>{let n=oi(),r=+t.getAttribute(`data-del`);n[r]&&confirm(`Delete group "${n[r].name}"?`)&&(n.splice(r,1),si(n),e())}}),document.querySelectorAll(`[data-auto]`).forEach(e=>{e.onchange=()=>{let t=oi(),n=+e.getAttribute(`data-auto`);t[n]&&(t[n].autoStart=e.checked,si(t))}})}}var mi=`nexterm_snippets`,hi=[{name:`Disk usage (human)`,category:`System`,cmd:`df -h`},{name:`Top memory processes`,category:`System`,cmd:`ps aux --sort=-%mem | head -n 12`},{name:`Tail a log file`,category:`Logs`,cmd:`tail -n {{lines:100}} -f {{path:/var/log/syslog}}`},{name:`Restart a service`,category:`Services`,cmd:`sudo systemctl restart {{service}}`},{name:`Service status`,category:`Services`,cmd:`systemctl status {{service}}`},{name:`Find large files`,category:`System`,cmd:`sudo find {{dir:/}} -type f -size +{{size:100M}} -exec ls -lh {} \\; 2>/dev/null`},{name:`Open ports`,category:`Network`,cmd:`ss -tulnp`},{name:`Ping host`,category:`Network`,cmd:`ping -c 4 {{host}}`},{name:`Grep in files`,category:`Files`,cmd:`grep -rn '{{pattern}}' {{dir:.}}`}];function gi(){try{let e=localStorage.getItem(mi);if(!e)return hi.slice();let t=JSON.parse(e);return Array.isArray(t)?t:hi.slice()}catch{return hi.slice()}}function _i(e){try{localStorage.setItem(mi,JSON.stringify(e))}catch{}}function vi(e){let t=/\{\{\s*([^}:]+?)\s*(?::([^}]*))?\}\}/g,n=new Map,r;for(;(r=t.exec(e))!==null;){let e=r[1].trim();n.has(e)||n.set(e,r[2]===void 0?``:r[2])}return[...n.entries()].map(([e,t])=>({name:e,def:t}))}function yi(e,n){return!y||y===`home`||!t[y]?(S(`Open a terminal first to run a snippet`,`warning`),!1):window.go&&window.go.main&&window.go.main.App&&window.go.main.App.WriteToTerminal?(window.go.main.App.WriteToTerminal(y,e+(n?`\r`:``)),!0):(S(`Cannot send command (WriteToTerminal unavailable)`,`error`),!1)}function bi(e){let t=vi(e.cmd),n=e.cmd;for(let e of t){let t=prompt(`Value for "${e.name}"${e.def?` (default: ${e.def})`:``}:`,e.def||``);if(t===null)return;let r=RegExp(`\\{\\{\\s*`+e.name.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)+`\\s*(?::[^}]*)?\\}\\}`,`g`);n=n.replace(r,t)}yi(n,!0)&&(U(),S(`Snippet sent to terminal`,`success`))}function xi(){e();function e(t=-1){let n=gi(),r=[...new Set(n.map(e=>e.category||`General`))].map(e=>`
    ...
    `).join(``)||`<div class="mon-empty">No snippets yet.</div>`,i=t>=0?gi()[t]:null,a=t===-2;H(`
      <div class="modal-header">
    ...
    `,`modal-lg`),document.getElementById(`snipClose`).onclick=U,document.getElementById(`snipNew`).onclick=()=>e(-2),document.querySelectorAll(`[data-run]`).forEach(e=>e.onclick=()=>bi(gi()[+e.getAttribute(`data-run`)])),document.querySelectorAll(`[data-copy]`).forEach(e=>e.onclick=()=>{let t=gi()[+e.getAttribute(`data-copy`)];yi(t.cmd,!1)&&(U(),S(`Snippet typed into terminal (not executed)`,`info`))}),document.querySelectorAll(`[data-edit]`).forEach(t=>t.onclick=()=>e(+t.getAttribute(`data-edit`))),document.querySelectorAll(`[data-del]`).forEach(t=>t.onclick=()=>{let n=gi(),r=+t.getAttribute(`data-del`);n[r]&&confirm(`Delete snippet "${n[r].name}"?`)&&(n.splice(r,1),_i(n),e())}),(t>=0||a)&&(document.getElementById(`snipCancelEdit`).onclick=()=>e(),document.getElementById(`snipSave`).onclick=()=>{let n=document.getElementById(`snipName`).value.trim(),r=document.getElementById(`snipCmd`).value.trim(),i=document.getElementById(`snipCat`).value.trim()||`General`;if(!n||!r){S(`Name and command are required`,`warning`);return}let o=gi();a?o.push({name:n,cmd:r,category:i}):o[t]={name:n,cmd:r,category:i},_i(o),e(),S(`Snippet saved`,`success`)})}}var Si=`nexterm_schedules`,Ci=null;function wi(){try{let e=JSON.parse(localStorage.getItem(Si));return Array.isArray(e)?e:[]}catch{return[]}}function Ti(e){try{localStorage.setItem(Si,JSON.stringify(e))}catch{}}function Ei(){try{let e=JSON.parse(localStorage.getItem(`nexterm_recordings`));return Array.isArray(e)?e:[]}catch{return[]}}function Di(e){let t=F(),n=T()[t];if(!t||t===`home`||!n)return!1;let r=window.go&&window.go.main&&window.go.main.App;if(!r||!r.WriteToTerminal)return!1;if(e.mode===`recording`){let n=Ei().find(t=>t.id===e.recordingId);if(!n)return!1;let i=0,a=()=>{if(!(i>=n.commands.length)){try{r.WriteToTerminal(t,n.commands[i]+`\r`)}catch{}i++,setTimeout(a,n.delayMs||600)}};a()}else try{r.WriteToTerminal(t,(e.command||``)+`\r`)}catch{}return!0}function Oi(){Ci||=setInterval(()=>{let e=Date.now(),t=!1,n=wi();n.forEach(n=>{if(n.enabled){if(!n.nextRun){n.nextRun=e+Math.max(5,n.everySec||60)*1e3,t=!0;return}e>=n.nextRun&&(Di(n),n.repeat?n.nextRun=e+Math.max(5,n.everySec||60)*1e3:(n.enabled=!1,n.nextRun=null),t=!0)}}),t&&Ti(n),document.getElementById(`schedRoot`)&&Mi()},1e3)}function ki(){H(`<div id="schedRoot"></div>`,`modal-plain`),Ni()}function Ai(e){if(e<=0)return`now`;let t=Math.ceil(e/1e3);if(t<60)return t+`s`;let n=Math.floor(t/60),r=t%60;return n+`m `+(r?r+`s`:``)}function ji(){let e=wi(),t=Ei(),n=Date.now();return e.length===0?`<div class="sched-empty">No scheduled tasks yet. Create one above — it runs on whichever terminal is focused when it fires.</div>`:e.map(e=>{let r=e.mode===`recording`?`▶ `+j((t.find(t=>t.id===e.recordingId)||{}).name||`(missing recording)`):`$ `+j(e.command||``),i=e.enabled?e.repeat?`every ${e.everySec}s · next in ${Ai((e.nextRun||n)-n)}`:`once · in ${Ai((e.nextRun||n)-n)}`:`paused`;return`
      <div class="sched-row">
      ...
      </div>`}).join(``)}function Mi(){let e=document.getElementById(`schedRoot`);if(!e)return;let t=e.querySelector(`.sched-list`);t&&(t.innerHTML=ji(),t.querySelectorAll(`.sched-toggle`).forEach(e=>e.onclick=()=>{let t=wi(),n=t.find(t=>t.id===e.getAttribute(`data-id`));n&&(n.enabled=!n.enabled,n.enabled&&(n.nextRun=Date.now()+Math.max(5,n.everySec||60)*1e3)),Ti(t),Mi()}),t.querySelectorAll(`.sched-run`).forEach(e=>e.onclick=()=>{let t=wi().find(t=>t.id===e.getAttribute(`data-id`));t&&(Di(t)?S(`Ran "${t.name}"`,`info`):S(`Focus a terminal first`,`warning`))}),t.querySelectorAll(`.sched-del`).forEach(e=>e.onclick=()=>{Ti(wi().filter(t=>t.id!==e.getAttribute(`data-id`))),Mi()}))}function Ni(){let e=document.getElementById(`schedRoot`);if(!e)return;let t=Ei(),n=t.map(e=>`<option value="${e.id}">${j(e.name)}</option>`).join(``);e.innerHTML=`
    ...
    </div>`,e.querySelector(`#schedClose`).onclick=()=>U();let r=e.querySelector(`#schedMode`),i=e.querySelector(`#schedCommand`),a=e.querySelector(`#schedRec`);r.onchange=()=>{let e=r.value===`recording`;a.style.display=e?``:`none`,i.style.display=e?`none`:``},e.querySelector(`#schedAdd`).onclick=()=>{let t=r.value,n=Math.max(5,parseInt(e.querySelector(`#schedEvery`).value,10)||60),o=e.querySelector(`#schedRepeat`).checked,s={id:`sch_`+Date.now(),name:(e.querySelector(`#schedName`).value||``).trim()||(t===`recording`?`Recording task`:`Command task`),mode:t,command:t===`command`?(i.value||``).trim():``,recordingId:t===`recording`?a.value:``,repeat:o,everySec:n,enabled:!0,nextRun:Date.now()+n*1e3};if(t===`command`&&!s.command){S(`Enter a command`,`warning`);return}if(t===`recording`&&!s.recordingId){S(`Pick a recording`,`warning`);return}let c=wi();c.unshift(s),Ti(c),S(`Scheduled "${s.name}"`,`success`),e.querySelector(`#schedName`).value=``,i&&(i.value=``),Mi()},Mi()}function Pi(){let e=t[y];if(e&&!e.isLocal&&e.isConnected)return e.id||y;let n=Object.entries(t).find(([e,t])=>t&&e!==`home`&&!t.isLocal&&t.isConnected);return n?n[1].id||n[0]:null}function Fi(){let e=Pi(),n=e?t[e]:null;return n?n.customTitle||n.profile&&(n.profile.name||n.profile.host)||`Server`:``}async function Ii(e){let t=Pi();if(!t)return{ok:!1,err:`no-target`};let n=window.go&&window.go.main&&window.go.main.App;if(!n||!n.RunSSHCommand)return{ok:!1,err:`no-bridge`};try{let r=await n.RunSSHCommand(t,e);return{ok:!0,out:r==null?``:String(r),id:t}}catch(e){return{ok:!1,err:String(e)}}}function Li(e){let t=Pi(),n=window.go&&window.go.main&&window.go.main.App;if(!t||!n||!n.WriteToTerminal)return!1;try{return n.WriteToTerminal(t,e+`\r`),!0}catch{return!1}}var Ri=`cpu`;function zi(e){let t=(e||``).split(`
`).map(e=>e.trim()).filter(Boolean),n=[];for(let e of t){if(/^PID\s+USER/i.test(e))continue;let t=e.match(/^(\d+)\s+(\S+)\s+([\d.]+)\s+([\d.]+)\s+(\S+)\s+(.*)$/);t&&n.push({pid:t[1],user:t[2],cpu:parseFloat(t[3]),mem:parseFloat(t[4]),comm:t[5],args:t[6]})}return n}function Bi(){if(!Pi()){S(`Connect to and focus a server first`,`warning`);return}H(`<div id="procRoot"></div>`,`modal-plain`),Vi()}async function Vi(){let e=document.getElementById(`procRoot`);e&&(e.innerHTML=`
    <div class="sx-card proc-card">
      <div class="sx-head">
        <div class="sx-title"><span class="sx-ico">🧩</span> Process Explorer — ${j(Fi())}</div>
      ...
      <div class="proc-sort">
        Sort: <button class="sx-btn sm ${Ri===`cpu`?`primary`:``}" data-k="cpu">CPU</button>
        <button class="sx-btn sm ${Ri===`mem`?`primary`:``}" data-k="mem">MEM</button>
        <button class="sx-btn sm ${Ri===`pid`?`primary`:``}" data-k="pid">PID</button>
      </div>
      <div class="proc-list" id="procList"><div class="sched-empty">Loading processes…</div></div>
    </div>`,e.querySelector(`#procClose`).onclick=()=>U(),e.querySelector(`#procRefresh`).onclick=()=>Hi(),e.querySelectorAll(`.proc-sort [data-k]`).forEach(e=>e.onclick=()=>{Ri=e.getAttribute(`data-k`),Vi()}),Hi())}async function Hi(){let e=document.getElementById(`procList`);if(!e)return;let t=await Ii(`ps -eo pid,user,pcpu,pmem,comm,args --sort=-pcpu 2>/dev/null | head -80`);if(!t.ok){e.innerHTML=`<div class="sched-empty">Couldn't read processes (${j(t.err||`error`)}). Needs a connected SSH server.</div>`;return}let n=zi(t.out);if(Ri===`mem`?n.sort((e,t)=>t.mem-e.mem):Ri===`pid`?n.sort((e,t)=>+e.pid-t.pid):n.sort((e,t)=>t.cpu-e.cpu),n.length===0){e.innerHTML=`<div class="sched-empty">No processes returned.</div>`;return}e.innerHTML=`
    ...
    ${n.map(e=>`
      ...
      </div>`).join(``)}`,e.querySelectorAll(`.proc-item`).forEach(e=>e.onclick=()=>Ui(e.getAttribute(`data-pid`)))}async function Ui(e){let t=document.getElementById(`procRoot`);if(!t)return;t.innerHTML=`
    <div class="sx-card proc-card">
      <div class="sx-head">
...
`).map(e=>(e.match(/:(\d+)\s/)||[])[1]).filter(Boolean):[];r.innerHTML=`
    ...
    <div class="proc-kv"><b>Listening ports</b><span class="mono">${u.length?u.join(`, `):`—`}</span></div>`}async function Wi(e,t){if(!confirm(`Send SIG${t} to process ${e}?`))return;let n=await Ii(`kill -${t} ${e} 2>&1 || sudo kill -${t} ${e} 2>&1`);S(n.ok?`Sent SIG${t} to ${e}`:`Kill failed`,n.ok?`success`:`error`),setTimeout(()=>Vi(),500)}var Gi={22:`SSH`,80:`HTTP`,443:`HTTPS`,3306:`MySQL`,5432:`PostgreSQL`,6379:`Redis`,27017:`MongoDB`,3e3:`Node/Dev`,8080:`HTTP-alt`,9200:`Elasticsearch`,5672:`RabbitMQ`,11211:`Memcached`,25:`SMTP`,53:`DNS`,21:`FTP`,3389:`RDP`,8e3:`HTTP-alt`,5e3:`Dev`};function Ki(e){let t=[];(e||``).split(`
`).forEach(e=>{if(e=e.trim(),!e||/^Netid|^State/i.test(e))return;let n=/^udp/i.test(e)?`udp`:/^tcp/i.test(e)||e.includes(`users:`)||e.includes(`:`)?`tcp`:``,r=e.match(/(\d{1,3}(?:\.\d{1,3}){3}|\[[0-9a-fA-F:]+\]|\*|0\.0\.0\.0|\[::\]):(\d+)\s/);if(!r)return;let i=r[2],a=``,o=``,s=e.match(/users:\(\("([^"]+)",pid=(\d+)/);s&&(a=s[1],o=s[2]),t.push({port:i,proto:n,proc:a,pid:o,svc:Gi[i]||``})});let n=new Set,r=[];return t.forEach(e=>{let t=e.port+e.proto;n.has(t)||(n.add(t),r.push(e))}),r.sort((e,t)=>+e.port-t.port),r}function qi(){if(!Pi()){S(`Connect to and focus a server first`,`warning`);return}H(`<div id="portRoot"></div>`,`modal-plain`),Ji()}async function Ji(){let e=document.getElementById(`portRoot`);e&&(e.innerHTML=`
    <div class="sx-card proc-card">
      <div class="sx-head">
        <div class="sx-title"><span class="sx-ico">🔌</span> Ports &amp; Services — ${j(Fi())}</div>
        <div style="display:flex;gap:6px;align-items:center">
    ...
    </div>`,e.querySelector(`#portClose`).onclick=()=>U(),e.querySelector(`#portRefresh`).onclick=()=>Yi(),Yi())}async function Yi(){let e=document.getElementById(`portList`);if(!e)return;let t=await Ii(`ss -tulnp 2>/dev/null || sudo ss -tulnp 2>/dev/null || netstat -tulnp 2>/dev/null`);if(!t.ok){e.innerHTML=`<div class="sched-empty">Couldn't scan ports (${j(t.err||`error`)}).</div>`;return}let n=Ki(t.out);if(n.length===0){e.innerHTML=`<div class="sched-empty">No listening ports found (process names may need sudo).</div>`;return}e.innerHTML=`
    ...
    ${n.map(e=>`
      ...
      </div>`).join(``)}`,e.querySelectorAll(`.port-item`).forEach(e=>e.onclick=()=>Xi(e.dataset.port,e.dataset.pid,e.dataset.proc))}async function Xi(e,t,n){let r=document.getElementById(`portRoot`);if(!r)return;r.innerHTML=`
    <div class="sx-card proc-card">
      <div class="sx-head">
    ...
    </div>`,r.querySelector(`#portBack`).onclick=()=>Ji();let i=r.querySelector(`#portKill`);i&&(i.onclick=async()=>{if(!confirm(`Kill process ${t} (${n}) on port ${e}?`))return;let r=await Ii(`kill -TERM ${t} 2>&1 || sudo kill -TERM ${t} 2>&1`);S(r.ok?`Killed ${t}`:`Kill failed`,r.ok?`success`:`error`),setTimeout(()=>Ji(),500)});let a=document.getElementById(`portDetail`);if(!t||t===`—`){a.innerHTML=`<div class="sched-empty">No owning process resolved for this port (try running the app's SSH user with sudo).</div>`;return}let o=await Ii([`echo '###USER'`,`ps -o user= -p ${t} 2>/dev/null`,`echo '###CMD'`,`ps -o args= -p ${t} 2>/dev/null`,`echo '###CWD'`,`readlink /proc/${t}/cwd 2>/dev/null`].join(` ; `));if(!o.ok){a.innerHTML=`<div class="sched-empty">Couldn't read details.</div>`;return}let s=e=>{let t=o.out.split(`###`).find(t=>t.startsWith(e));return t?t.slice(e.length).trim():``};a.innerHTML=`
    <div class="proc-kv"><b>Service</b><span>${j(Gi[e]||`—`)}</span></div>
    ...
    <div class="proc-kv"><b>Directory</b><span class="mono">${j(s(`CWD`)||`—`)}</span></div>`}var Zi=null,q={path:``,search:``,regex:!1,errorsOnly:!1,lines:300,raw:[]};function Qi(e){return/\b(ERR|ERROR|FATAL|CRIT|CRITICAL|PANIC|EXCEPTION|FAIL(ED|URE)?)\b/i.test(e)?`err`:/\b(WARN|WARNING)\b/i.test(e)?`warn`:/\b(INFO|NOTICE)\b/i.test(e)?`info`:/\b(DEBUG|TRACE)\b/i.test(e)?`debug`:``}function $i(){if(!Pi()){S(`Connect to and focus a server first`,`warning`);return}H(`<div id="logRoot"></div>`,`modal-plain`),ta()}function ea(){Zi&&=(clearInterval(Zi),null)}function ta(){let e=document.getElementById(`logRoot`);e&&(e.innerHTML=`
    <div class="sx-card log-card">
      <div class="sx-head">
        <div class="sx-title"><span class="sx-ico">📜</span> Log Explorer — ${j(Fi())}</div>
      ...
      <div class="log-controls">
        ...
        <button class="sx-btn primary" id="logStart">${Zi?`■ Stop`:`▶ Tail`}</button>
      </div>
      <div class="log-controls">
    ...
    </div>`,e.querySelector(`#logClose`).onclick=()=>{ea(),U()},e.querySelector(`#logStart`).onclick=()=>na(),e.querySelector(`#logPath`).onchange=e=>{q.path=e.target.value.trim()},e.querySelector(`#logSearch`).oninput=e=>{q.search=e.target.value,ia()},e.querySelector(`#logRegex`).onchange=e=>{q.regex=e.target.checked,ia()},e.querySelector(`#logErr`).onchange=e=>{q.errorsOnly=e.target.checked,ia()})}async function na(){let e=document.getElementById(`logPath`);if(e&&(q.path=e.value.trim()),Zi){ea(),ta();return}if(!q.path){S(`Enter a log file path`,`warning`);return}await ra(),Zi=setInterval(ra,3e3),ta()}async function ra(){let e=await Ii(`tail -n ${q.lines} ${JSON.stringify(q.path)} 2>&1`);if(!e.ok){let t=document.getElementById(`logView`);t&&(t.innerHTML=`<div class="sched-empty">Can't read log (${j(e.err||`error`)}).</div>`);return}q.raw=e.out.split(`
`),ia()}function ia(){let e=document.getElementById(`logView`);if(!e)return;let t=q.raw,n=null;if(q.search&&q.regex)try{n=new RegExp(q.search,`i`)}catch{n=null}let r={err:0,warn:0,info:0,debug:0},i=t.filter(e=>{let t=Qi(e);return t&&(r[t]=(r[t]||0)+1),q.errorsOnly&&t!==`err`&&t!==`warn`?!1:q.search?n?n.test(e):e.toLowerCase().includes(q.search.toLowerCase()):!0});e.innerHTML=i.length===0?`<div class="sched-empty">No matching lines.</div>`:i.map(e=>`<div class="log-line log-${Qi(e)||`plain`}">${j(e)}</div>`).join(``),e.scrollTop=e.scrollHeight;let a=document.getElementById(`logFoot`);a&&(a.innerHTML=`<span class="log-badge err">${r.err} err</span><span class="log-badge warn">${r.warn} warn</span><span class="log-badge info">${r.info} info</span><span class="log-muted">${i.length}/${q.raw.length} lines${Zi?` · live`:``}</span>`)}var aa=[{re:/(?:which\s+)?(?:process|pid).*port\s+(\d+)|port\s+(\d+).*(?:process|pid|use|using)|what.*(?:on|uses)\s+port\s+(\d+)/i,build:e=>({cmd:`ss -tlnp 2>/dev/null | grep :${e[1]||e[2]||e[3]} || sudo ss -tlnp | grep :${e[1]||e[2]||e[3]}`,label:`Find what uses port ${e[1]||e[2]||e[3]}`,kind:`read`})},{re:/(?:show|view|open|tail)\s+(.+?)\s+logs?|logs?\s+(?:of|for)\s+(.+)/i,build:e=>{let t=(e[1]||e[2]||``).trim();return{cmd:`journalctl -u ${t} -n 120 --no-pager 2>&1 || sudo journalctl -u ${t} -n 120 --no-pager 2>&1`,label:`Show logs for ${t}`,kind:`read`}}},{re:/restart\s+(\S+)/i,build:e=>({cmd:`sudo systemctl restart ${e[1]}`,label:`Restart ${e[1]}`,kind:`action`,destructive:!0})},{re:/stop\s+(\S+)/i,build:e=>({cmd:`sudo systemctl stop ${e[1]}`,label:`Stop ${e[1]}`,kind:`action`,destructive:!0})},{re:/start\s+(\S+)/i,build:e=>({cmd:`sudo systemctl start ${e[1]}`,label:`Start ${e[1]}`,kind:`action`})},{re:/status\s+(?:of\s+)?(\S+)/i,build:e=>({cmd:`systemctl status ${e[1]} --no-pager 2>&1 || sudo systemctl status ${e[1]} --no-pager 2>&1`,label:`Status of ${e[1]}`,kind:`read`})},{re:/^(?:open|cd|go to)\s+(\/\S+)/i,build:e=>({cmd:`cd ${e[1]}`,label:`cd to ${e[1]}`,kind:`action`})},{re:/open\s+log\s*explorer|log\s*explorer/i,build:()=>({special:`logexplorer`,label:`Open Log Explorer`,kind:`action`})},{re:/disk|storage|df\b/i,build:()=>({cmd:`df -h`,label:`Disk usage`,kind:`read`})},{re:/memory|ram|free\b/i,build:()=>({cmd:`free -h`,label:`Memory usage`,kind:`read`})},{re:/who|logged|users\b/i,build:()=>({cmd:`who`,label:`Logged-in users`,kind:`read`})},{re:/top\s+(?:cpu|process)|cpu\s+hog|heaviest/i,build:()=>({cmd:`ps -eo pid,pcpu,pmem,comm --sort=-pcpu 2>/dev/null | head -12`,label:`Top CPU processes`,kind:`read`})},{re:/uptime|load/i,build:()=>({cmd:`uptime`,label:`Uptime & load`,kind:`read`})},{re:/explain\s+(.+)/i,build:e=>({explain:(e[1]||``).trim(),label:`Explain command`,kind:`read`})}];function oa(e){for(let t of aa){let n=e.match(t.re);if(n)return t.build(n)}return null}function sa(){H(`<div id="ciRoot"></div>`,`modal-plain`),ca()}function ca(){let e=document.getElementById(`ciRoot`);if(!e)return;e.innerHTML=`
    <div class="sx-card ci-card">
    ...
    </div>`,e.querySelector(`#ciClose`).onclick=()=>U();let t=e.querySelector(`#ciInput`);t.onkeydown=e=>{e.key===`Enter`&&la(t.value)},e.querySelectorAll(`.ci-chip`).forEach(e=>e.onclick=()=>{t.value=e.getAttribute(`data-h`),la(t.value)}),setTimeout(()=>t.focus(),30)}function la(e){e=(e||``).trim();let t=document.getElementById(`ciResult`);if(!t)return;if(!e){t.innerHTML=``;return}let n=oa(e);if(!n){t.innerHTML=`
      ...
      </div>`,t.querySelector(`#ciRunRaw`).onclick=()=>da(e,!0);return}if(n.special===`logexplorer`){U(),$i();return}if(n.explain){t.innerHTML=`<div class="ci-card-plan"><div class="ci-plan-label">${j(n.label)}</div>
    ...
    </div>`,t.querySelector(`#ciRun`).onclick=()=>{r?ua(n.cmd):da(n.cmd,n.destructive)}}async function ua(e){if(!Pi()){S(`Connect to and focus a server first`,`warning`);return}let t=document.getElementById(`ciOut`);t&&(t.innerHTML=`<div class="sched-empty">Running…</div>`);let n=await Ii(e);t&&(t.innerHTML=n.ok?`<pre class="ci-output">${j(n.out||`(no output)`)}</pre>`:`<div class="sched-empty">Failed (${j(n.err||`error`)}).</div>`)}function da(e,t){(!t||confirm(`Run this command on the active terminal?\n\n${e}`))&&(Li(e)?(S(`Sent to active terminal`,`success`),U()):S(`Focus a terminal first`,`warning`))}var fa=[{title:`Sessions & Tabs`,items:[[`Ctrl + N`,`New SSH session`],[`Ctrl + W`,`Close current tab`],[`Ctrl + K`,`Command palette / quick search`],[`Alt + M`,`Toggle MultiExec broadcast bar`],[`Ctrl+Alt + B`,`Broadcast command to servers`]]},{title:`Workspace & Split`,items:[[`Ctrl+Shift + E`,`Split right (vertical)`],[`Ctrl+Shift + O`,`Split down (horizontal)`],[`Ctrl+Shift + M`,`Maximize / restore active pane`],[`Ctrl+Shift + \\`,`Toggle vertical split`],[`Ctrl+Shift + -`,`Toggle horizontal split`]]},{title:`Terminal`,items:[[`Ctrl+Shift + F`,`Find in terminal scrollback`],[`Ctrl + F`,`Find in terminal`],[`Ctrl + B`,`Toggle sidebar`],[`Esc`,`Close dialog / palette / menu`]]},{title:`Help`,items:[[`F1  or  Shift + ?`,`Show this shortcuts sheet`]]}];function pa(){H(`
    <div class="modal-header">
  ...
  `),i=r.querySelector(`#renameNodeInput`);i.focus(),i.select();let a=async()=>{let n=i.value.trim();if(!n||n===t){U();return}U();try{window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.RenameNode(e,n),await _a(),S(`Renamed to "${n}"`,`success`)}catch(e){S(`Rename failed: `+e,`error`)}};r.querySelector(`#modalSave`).onclick=a,r.querySelector(`#modalCancel`).onclick=U,r.querySelector(`#modalClose`).onclick=U,i.onkeydown=e=>{e.key===`Enter`&&a()}}function xa(e,t,n=!1){let r=[];function i(t,a=``){if(!t||t.session||n&&(t.id===e||oe(e,t.id)))return;let o=a?`${a} / ${t.name}`:t.name;r.push({id:t.id,name:t.name,path:o}),t.children&&t.children.forEach(e=>i(e,o))}i(I);let a=H(`
    <div class="modal-header">
  ...
  `);a.querySelectorAll(`.folder-picker-item`).forEach(n=>{n.onmouseover=()=>n.style.background=`rgba(59, 130, 246, 0.15)`,n.onmouseout=()=>n.style.background=`rgba(255,255,255,0.03)`,n.onclick=async()=>{let r=n.dataset.id;U();try{window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.MoveNode(e,r,-1),await _a(),S(`Moved "${t}"`,`success`)}catch(e){S(`Move failed: `+e,`error`)}}}),a.querySelector(`#modalCancel`).onclick=U,a.querySelector(`#modalClose`).onclick=U}var Sa=null;function Ca(e){Sa=e}var wa=null;function Ta(e){wa=e}async function Ea(){Sa&&await Sa()}async function Da(e){if(!e)return!1;try{if(navigator.clipboard&&navigator.clipboard.writeText)return await navigator.clipboard.writeText(e),!0}catch{}try{let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.left=`-9999px`,t.style.top=`-9999px`,t.style.opacity=`0`,document.body.appendChild(t),t.focus(),t.select();let n=document.execCommand(`copy`);return document.body.removeChild(t),n}catch{return!1}}function Oa(e){if(!e)return``;let t=(e.protocol||`ssh`).toLowerCase(),n=e.host||`localhost`,r=t===`rdp`?3389:t===`vnc`?5900:t===`telnet`?23:22,i=e.port||r,a=e.username||``;switch(t){case`ssh`:return a?`ssh -p ${i} ${a}@${n}`:`ssh -p ${i} ${n}`;case`sftp`:return a?`sftp://${a}@${n}:${i}`:`sftp://${n}:${i}`;case`telnet`:return`telnet ${n} ${i}`;case`rdp`:return`mstsc.exe /v:${n}:${i}`;case`vnc`:return`vnc://${n}:${i}`;case`serial`:return`Serial: ${e.port||`COM1`} (Baud: ${e.baudRate||9600})`;case`local`:return`Local Shell: ${e.shellPath||`powershell.exe`}`;default:return`${t}://${a?a+`@`:``}${n}:${i}`}}async function ka(e){if(!e)return;let n=(e.protocol||`ssh`).toLowerCase();if(n!==`ssh`&&n!==`sftp`){S(`SFTP is only available for SSH and SFTP sessions`,`warning`);return}let r=null;if(t){for(let[n,i]of Object.entries(t))if(i&&i.profile&&(i.profile.id===e.id||i.profile.host===e.host&&i.profile.username===e.username)){r=n;break}}r?(Pn(r),wa&&wa(t[r].sftpPath||`~`),S(`Opened SFTP for "${e.name}"`,`success`)):(S(`Connecting to "${e.name}" for SFTP...`,`info`),V(e),wa&&setTimeout(()=>wa(`~`),650))}function Aa(e){if(!e)return;let n=(e.protocol||`ssh`).toUpperCase(),r=Oa(e),i=!1;if(t){for(let n of Object.values(t))if(n&&n.profile&&n.profile.id===e.id){i=!0;break}}if(!H(`
    <div class="modal-header">
      <div class="modal-title" style="display:flex; align-items:center; gap:8px;">
  ...
  `,`session-props-modal`))return;let a=()=>U(),o=document.getElementById(`propModalClose`),s=document.getElementById(`propCloseBtn`);o&&(o.onclick=a),s&&(s.onclick=a);let c=document.getElementById(`propCopyBtn`);c&&(c.onclick=async()=>{await Da(r),S(`Copied: ${r}`,`success`)});let l=document.getElementById(`propSFTPBtn`);l&&(l.onclick=()=>{a(),ka(e)});let u=document.getElementById(`propEditBtn`);u&&(u.onclick=()=>{a(),J(``,e)});let d=document.getElementById(`propConnectBtn`);d&&(d.onclick=()=>{a(),V(e)})}function ja(e,t,n){let r=ke();if(!r)return;let i=n.id===(I?I.id:``);r.innerHTML=`
    ...
    `}
  `,Ae(e,t);let a=r.querySelector(`#cConnectAllFold`);a&&(a.onclick=()=>{R(),Re(n)});let o=r.querySelector(`#cConnectBcastFold`);o&&(o.onclick=()=>{R(),Le(n)}),r.querySelector(`#cAddSess`).onclick=()=>{R(),J(n.id)},r.querySelector(`#cAddFold`).onclick=()=>{R(),ya(n.id)};let s=r.querySelector(`#cFolderProps`);s&&(s.onclick=()=>{R(),ya(n.parentId||``,n)});let c=r.querySelector(`#cRenFold`);c&&(c.onclick=()=>{R(),ba(n.id,n.name,!0)});let l=r.querySelector(`#cMoveFold`);l&&(l.onclick=()=>{R(),xa(n.id,n.name,!0)}),r.querySelector(`#cExpFold`).onclick=async()=>{R(),n.expanded=!0,window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.ToggleFolder(n.id,!0),await Ea(),S(`Expanded "${n.name}"`,`info`)},r.querySelector(`#cColFold`).onclick=async()=>{R(),n.expanded=!1,window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.ToggleFolder(n.id,!1),await Ea(),S(`Collapsed "${n.name}"`,`info`)};let u=r.querySelector(`#cDelFold`);u&&(u.onclick=async()=>{R();let e=n.children?n.children.length:0,t=e>0?`Are you sure you want to delete folder "${n.name}" and its ${e} item(s)?`:`Are you sure you want to delete folder "${n.name}"?`;if(confirm(t))try{window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.DeleteNode(n.id),await Ea(),S(`Deleted folder "${n.name}"`,`info`)}catch(e){S(`Delete failed: `+e,`error`)}})}function Ma(e,t,n,r){let i=ke();i&&(i.innerHTML=`
...
`)&&(i+=` `),i}function za(e,t){if(!t)return;let n=t.octalPerm||`0755`;n.length===3&&(n=`0`+n);let r=H(`
  ...
  `);if(!r)return;let i=r.querySelector(`#propChmodBtn`);i&&(i.onclick=()=>{U(),za(t,n)});let a=r.querySelector(`#modalCloseBtn`);a&&(a.onclick=U);let o=r.querySelector(`#modalClose`);o&&(o.onclick=U)}async function Ha(e,t=!1){let n=F();if(!n||!window.go||!window.go.main||!window.go.main.App){S(`Open an SSH connection first`,`warning`);return}let r=e.substring(e.lastIndexOf(`/`)+1);S(`Downloading & opening ${r}...`,`info`);try{await window.go.main.App.SFTPOpenExternal(n,e,t),S(`Opened ${r} (${t?`App Chooser`:`Default Program`}). Live sync watching for edits.`,`success`)}catch(e){S(`Failed to open file externally: `+e,`error`)}}function Ua(e){let{tabId:t,remotePath:n,localPath:r,fileName:i,modTime:a}=e;if(W.autoSaveExternalEdits){Ga(t,n,r,i);return}Wa(t,n,r,i,a)}function Wa(e,t,n,r,i){let a=`banner-`+btoa(e+`:`+t).replace(/=/g,``),o=document.getElementById(a);o&&o.remove();let s=document.createElement(`div`);s.id=a,s.className=`file-change-banner`,s.innerHTML=`
  ...
  `,document.body.appendChild(s),s.querySelector(`#btnCommit_${a}`).onclick=()=>{s.remove(),Ga(e,t,n,r)},s.querySelector(`#btnAuto_${a}`).onclick=()=>{W.autoSaveExternalEdits=!0,localStorage.setItem(`nexterm_settings`,JSON.stringify(W)),s.remove(),S(`Always auto-save enabled: future modifications will save directly`,`info`),Ga(e,t,n,r)},s.querySelector(`#btnDiscard_${a}`).onclick=()=>{s.remove(),S(`Discarded change notification for ${r}`,`info`)}}async function Ga(e,t,n,r){if(window.go&&window.go.main&&window.go.main.App)try{S(`Committing & saving ${r} to remote server...`,`info`),await window.go.main.App.SFTPCommitExternalChange(e,t,n),S(`✅ Changes committed & directly saved to ${r}!`,`success`),F()===e&&typeof Na==`function`&&Na()}catch(e){S(`Failed to commit change to server: `+e,`error`)}}async function Ka(e=``){let t=F(),n=T(),r=t?n[t]:null,i=r&&r.profile&&(r.profile.host||r.profile.name)||`workspace`,a=e?e.substring(e.lastIndexOf(`/`)+1):`main.js`,o=e?`${i}:${e}`:`scratchpad:${a}`,s=``;if(e){if(!t||!window.go||!window.go.main||!window.go.main.App){S(`Open an SSH connection first to edit remote files`,`warning`);return}S(`Opening ${a}...`,`info`);try{s=await window.go.main.App.SFTPReadFile(t,e)}catch(e){S(`Failed to open remote file: `+e,`error`);return}}else s=`const btn = document.getElementById('btn');
let count = 0;
...
`;let c=La(a),l=`🐧 Linux`;s.includes(`\r
...
`);if(t<=e.length){let n=0;for(let r=0;r<t-1;r++)n+=e[r].length+1;d.focus(),d.setSelectionRange(n,n),M()}}}}}var Y=`/`,qa=[],X=null,Ja=`name`,Ya=`asc`,Xa=!0,Za=[`/`,`~`,`/opt`,`/etc`,`/var/log`,`/tmp`];function Qa(e){Ja=e}function $a(e){Ya=e}function eo(e){Xa=e}var to=null;function no(e){to=e}function ro(){if(!Y||Y===`/`)return;let e=Y.lastIndexOf(`/`),t=Y.substring(0,e);(!t||t===``)&&(t=`/`),Z(t)}async function Z(e=``){let n=document.getElementById(`sftpFileList`),r=document.getElementById(`sftpPathInput`),i=document.getElementById(`sftpCountBadge`);if(!n)return;if(!y||y===`home`||!t[y]||t[y].isLocal){n.innerHTML=`<div class="sftp-empty-hint">Connect to an SSH server to browse remote files via SFTP</div>`,i&&(i.textContent=`0 items`);return}let a=t[y],o=e||a&&a.sftpPath||Y||`~`;n.innerHTML=`<div class="sftp-empty-hint">Loading files from ${j(o)}...</div>`;try{if(window.go&&window.go.main&&window.go.main.App){let e=await window.go.main.App.SFTPList(y,o);Y=e&&e.path||o,a&&(a.sftpPath=Y),r&&(r.value=Y),Y&&!Za.includes(Y)&&(Za.unshift(Y),Za.length>15&&Za.pop(),io()),qa=e&&e.items||[],so(qa,Y),to&&to()}else{let e=a.profile&&a.profile.username||`pin`;Y=o===`~`||!o||o===`/`?`/home/${e}`:o,a&&(a.sftpPath=Y),r&&(r.value=Y),qa=[{name:`Videos`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Videos`},{name:`Templates`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Templates`},{name:`Public`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Public`},{name:`Portal`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Portal`},{name:`Pictures`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Pictures`},{name:`Music`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Music`},{name:`Downloads`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Downloads`},{name:`Documents`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Documents`},{name:`Desktop`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 15:10`,path:`${Y}/Desktop`},{name:`.vim`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 12:00`,path:`${Y}/.vim`},{name:`.ssh`,isDir:!0,size:4096,permissions:`drwx------`,modTime:`2026-09-15 12:30`,path:`${Y}/.ssh`},{name:`.pki`,isDir:!0,size:4096,permissions:`drwx------`,modTime:`2026-09-15 12:00`,path:`${Y}/.pki`},{name:`.mozilla`,isDir:!0,size:4096,permissions:`drwx------`,modTime:`2026-09-15 12:00`,path:`${Y}/.mozilla`},{name:`.local`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 12:00`,path:`${Y}/.local`},{name:`.java`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 12:00`,path:`${Y}/.java`},{name:`.dbus`,isDir:!0,size:4096,permissions:`drwx------`,modTime:`2026-09-15 12:00`,path:`${Y}/.dbus`},{name:`.config`,isDir:!0,size:4096,permissions:`drwxr-xr-x`,modTime:`2026-09-15 12:00`,path:`${Y}/.config`},{name:`.cache`,isDir:!0,size:4096,permissions:`drwx------`,modTime:`2026-09-15 12:00`,path:`${Y}/.cache`},{name:`Infranet.properties`,isDir:!1,size:1024,permissions:`-rw-r--r--`,modTime:`2026-09-15 14:00`,path:`${Y}/Infranet.properties`},{name:`default.pinlog`,isDir:!1,size:1024,permissions:`-rw-r--r--`,modTime:`2026-09-15 14:05`,path:`${Y}/default.pinlog`},{name:`dead.letter`,isDir:!1,size:1024,permissions:`-rw-r--r--`,modTime:`2026-09-15 14:10`,path:`${Y}/dead.letter`},{name:`.Xauthority`,isDir:!1,size:1024,permissions:`-rw-------`,modTime:`2026-09-15 14:12`,path:`${Y}/.Xauthority`},{name:`.wget-hsts`,isDir:!1,size:1024,permissions:`-rw-------`,modTime:`2026-09-15 14:15`,path:`${Y}/.wget-hsts`}],so(qa,Y),to&&to()}}catch(e){n.innerHTML=`<div class="sftp-empty-hint" style="color: var(--accent-red); padding: 16px 12px; line-height: 1.5;">
    ...
    </div>`;let t=document.getElementById(`sftpRetryHomeBtn`);t&&(t.onclick=()=>Z(`~`))}}function io(){let e=document.getElementById(`sftpRecentPathsContainer`);if(!e)return;e.innerHTML=``;let t=Za.filter(e=>![`/`,`~`,`/opt`,`/etc`,`/var/log`,`/tmp`,`/home`].includes(e));if(t.length>0){let n=document.createElement(`div`);n.style.cssText=`border-top: 1px solid #38383e; margin: 4px 0;`,e.appendChild(n),t.slice(0,8).forEach(t=>{let n=document.createElement(`div`);n.className=`moba-path-item`,n.dataset.path=t,n.textContent=t,n.onclick=()=>{ao(),Z(t)},e.appendChild(n)})}}function ao(){let e=document.getElementById(`sftpPathDropdownMenu`);e&&e.classList.add(`hidden`)}function oo(){let e=document.getElementById(`sftpPathDropdownMenu`);e&&e.classList.toggle(`hidden`)}function so(e,t=Y){let n=document.getElementById(`sftpFileList`),r=document.getElementById(`sftpCountBadge`);if(!n)return;let i=[...e];Xa||(i=i.filter(e=>!e.name.startsWith(`.`))),i.sort((e,t)=>{if(e.isDir!==t.isDir)return e.isDir?-1:1;if(Ja===`size`){let n=(e.size||0)-(t.size||0);return Ya===`asc`?n:-n}{let n=(e.name||``).localeCompare(t.name||``,void 0,{sensitivity:`base`});return Ya===`asc`?n:-n}});let a=i.filter(e=>e.isDir).length,o=i.filter(e=>!e.isDir).length;if(r&&(r.textContent=`${i.length} items (${a} dirs, ${o} files)`),n.innerHTML=``,t&&t!==`/`&&t!==``){let e=document.createElement(`div`);e.className=`moba-file-row moba-parent-row`,e.title=`Go to parent directory (Click or Double-click)`,e.innerHTML=`
    ...
    `,e.addEventListener(`click`,e=>{e.stopPropagation(),ro()}),e.addEventListener(`dblclick`,e=>{e.stopPropagation(),ro()}),n.appendChild(e)}if(i.length===0){let e=document.createElement(`div`);e.className=`sftp-empty-hint`,e.textContent=`Directory is empty`,n.appendChild(e);return}i.forEach(e=>{let t=document.createElement(`div`);t.className=`moba-file-row ${X&&X.path===e.path?`selected`:``} ${e.isDir?`is-dir`:`is-file`}`,t.dataset.path=e.path,t.dataset.isDir=e.isDir;let r=Fa(e),i=Ia(e.size,e.isDir),a=`${e.path}\nSize: ${e.formattedSize||e.size+` B`}\nPermissions: ${e.permissions||`N/A`}\nModified: ${e.modTime||`N/A`}`;t.innerHTML=`
    ...
    `;let b=a.querySelector(`.connected-env-btn`);b&&(b.onclick=e=>{e.stopPropagation();let n=b.getBoundingClientRect();Vn(n.right+6,n.top,t)});let x=a.querySelector(`.connected-options-btn`);x&&(x.onclick=e=>{e.stopPropagation();let n=x.getBoundingClientRect();Bn(n.right+6,n.top,t)}),a.oncontextmenu=e=>{e.preventDefault(),e.stopPropagation(),Bn(e.clientX,e.clientY,t)},a.onclick=e=>{if(!(e.target.closest(`.connected-env-btn`)||e.target.closest(`.connected-options-btn`)||e.target.closest(`.connected-item-close`))){if(y===t){let e=a.getBoundingClientRect();Bn(e.right+6,e.top,t)}else Pn(t)}};let S=a.querySelector(`.connected-item-close`);S&&(S.onclick=e=>{e.stopPropagation(),Fn(t)}),n.appendChild(a)})}function po(e){e&&(e.session||(Array.isArray(e.children)||(e.children=[]),e.expanded===void 0&&(e.expanded=!0),e.children.forEach(po)))}async function Q(e=``){try{if(window.go&&window.go.main&&window.go.main.App){let e=await window.go.main.App.GetSessionTree();po(e),ae(e)}else ae({id:`root`,name:`SAVED SESSIONS`,expanded:!0,children:[{id:`f1`,name:`Production`,expanded:!0,children:[]},{id:`f2`,name:`UAT`,expanded:!0,children:[]},{id:`f3`,name:`Testing`,expanded:!0,children:[]},{id:`f4`,name:`Local`,expanded:!0,children:[]},{id:`f5`,name:`Client`,expanded:!0,children:[]},{id:`f6`,name:`User`,expanded:!0,children:[]}]});go(e),vo(null,e)}catch(e){console.error(`Failed to load session tree:`,e)}}function mo(e){switch(e&&e.protocol?e.protocol.toLowerCase():`ssh`){case`sftp`:return{icon:`📦`,badge:`SFTP`,cls:`sftp`};case`rdp`:return{icon:`🪟`,badge:`RDP`,cls:`rdp`};case`vnc`:return{icon:`🖥️`,badge:`VNC`,cls:`vnc`};case`telnet`:return{icon:`📡`,badge:`TELNET`,cls:`telnet`};case`serial`:return{icon:`🔌`,badge:`SERIAL`,cls:`serial`};case`local`:return{icon:`💻`,badge:`LOCAL`,cls:`local`};default:return{icon:`🔑`,badge:`SSH`,cls:`ssh`}}}function ho(){let e=lo();document.querySelectorAll(`.tree-node-row.drag-target-over`).forEach(e=>e.classList.remove(`drag-target-over`)),document.querySelectorAll(`.tree-node-row.drag-insert-above`).forEach(e=>e.classList.remove(`drag-insert-above`)),document.querySelectorAll(`.tree-node-row.drag-insert-below`).forEach(e=>e.classList.remove(`drag-insert-below`)),e&&e.classList.remove(`drag-target-root`)}function go(e=``){let t=lo();if(!t||(t.innerHTML=``,!I))return;let n=e.trim().toLowerCase();if(t.dataset.hasDropListener||(t.dataset.hasDropListener=`true`,t.addEventListener(`dragover`,e=>{e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`drag-target-root`)}),t.addEventListener(`dragleave`,e=>{t.contains(e.relatedTarget)||t.classList.remove(`drag-target-root`)}),t.addEventListener(`drop`,async e=>{if(!e.target.closest(`.tree-node-row`)){e.preventDefault(),t.classList.remove(`drag-target-root`);try{let t=e.dataTransfer.getData(`text/plain`);if(!t)return;let n=JSON.parse(t);if(!n.nodeId||n.nodeId===I.id)return;window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.MoveNode(n.nodeId,I.id,-1),await Q(),S(`Moved "${n.nodeName}" to All Sessions`,`success`)}catch(e){console.error(`Drop to root error:`,e)}}})),I.children&&I.children.length>0)I.children.forEach(e=>{let r=_o(e,n,I,0);r&&t.appendChild(r)});else{let e=_o(I,n,null,0);e&&t.appendChild(e)}}function _o(e,n=``,a=null,o=0){if(!e)return null;let s=!e.session,c=!n||e.name.toLowerCase().includes(n)||e.session&&(e.session.host&&e.session.host.toLowerCase().includes(n)||e.session.username&&e.session.username.toLowerCase().includes(n)),l=[];if(s&&e.children&&(l=e.children.map(t=>_o(t,n,e,o+1)).filter(e=>e!==null)),n&&!c&&l.length===0)return null;let u=document.createElement(`div`),d=document.createElement(`div`);if(d.className=`tree-node-row ${s?`folder`:`session`}`,d.dataset.id=e.id,d.dataset.level=o,d.draggable=!0,s){let t=e.expanded!==!1,n=r(e.environment)||i(e.name),o=n?`<span class="tree-node-env-badge env-${n.key}" style="color:${n.color}; background:${n.bg}; border: 1px solid ${n.border}; font-size: 9px; padding: 0 4px; margin-left: 4px;">${n.label}</span>`:``,s=e.defaultUsername?`<span class="tree-folder-user" style="font-size: 10px; color: var(--text-dim); margin-left: auto; margin-right: 4px;" title="Default username: ${j(e.defaultUsername)}">👤 ${j(e.defaultUsername)}</span>`:``;d.innerHTML=`
    ...
    `;let c=d.querySelector(`.folder-options-btn`);c&&(c.onclick=t=>{t.stopPropagation(),t.preventDefault();let n=c.getBoundingClientRect();ja(n.right+4,n.top,e)}),d.addEventListener(`click`,t=>{t.stopPropagation(),e.expanded=!e.expanded;let n=document.getElementById(`sidebarQuickConnectInput`)||document.getElementById(`sidebarQuickConnect`);go(n?n.value:``),window.go&&window.go.main&&window.go.main.App&&window.go.main.App.ToggleFolder(e.id,e.expanded)}),d.addEventListener(`contextmenu`,t=>{t.preventDefault(),t.stopPropagation(),ja(t.clientX,t.clientY,e)}),d.addEventListener(`dragstart`,t=>{t.stopPropagation(),t.dataTransfer.setData(`text/plain`,JSON.stringify({nodeId:e.id,nodeName:e.name,isFolder:!0})),t.dataTransfer.effectAllowed=`move`,d.classList.add(`dragging`)}),d.addEventListener(`dragend`,e=>{e.stopPropagation(),d.classList.remove(`dragging`),ho()}),d.addEventListener(`dragover`,e=>{e.preventDefault(),e.stopPropagation(),e.dataTransfer.dropEffect=`move`;let t=d.getBoundingClientRect(),n=(e.clientY-t.top)/t.height;d.classList.remove(`drag-insert-above`,`drag-insert-below`,`drag-target-over`),n<.25?d.classList.add(`drag-insert-above`):n>.75?d.classList.add(`drag-insert-below`):d.classList.add(`drag-target-over`)}),d.addEventListener(`dragleave`,e=>{e.stopPropagation(),d.classList.remove(`drag-insert-above`,`drag-insert-below`,`drag-target-over`)}),d.addEventListener(`drop`,async t=>{t.preventDefault(),t.stopPropagation();let n=d.classList.contains(`drag-insert-above`),r=d.classList.contains(`drag-insert-below`);ho();try{let i=t.dataTransfer.getData(`text/plain`);if(!i)return;let o=JSON.parse(i);if(!o.nodeId||o.nodeId===e.id)return;if(o.isFolder&&oe(o.nodeId,e.id)){S(`Cannot move folder into itself or its subfolder`,`warning`);return}let s=e.id,c=-1;if(n||r){s=a?a.id:I.id;let t=(a&&a.children?a.children:I.children||[]).findIndex(t=>t.id===e.id);c=n?Math.max(0,t):t+1}window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.MoveNode(o.nodeId,s,c),await Q(),S(`Moved "${o.nodeName}"`,`success`)}catch(e){console.error(`Drop error:`,e),S(`Move failed: ${e}`,`error`)}})}else{let n=mo(e.session),o=Object.values(t).some(t=>t.profile&&t.profile.id===e.session.id&&t.isConnected),s=a?i(a.name):null,c=s||r(e.session.environment||e.session.color),l=(s?s.color:e.session.color)||(c?c.color:``),u=c?`<span class="tree-node-env-badge env-${c.key}" style="color:${c.color}; background:${c.bg}; border-color:${c.border};">${c.label}</span>`:``;d.innerHTML=`
    ...
    `;let e=o.querySelector(`#homeCreateSessBtn`);e&&(e.onclick=()=>{on(()=>Promise.resolve().then(()=>ma).then(e=>e.showNewSessionDialog()),void 0)});return}let d=(n||``).trim().toLowerCase(),f=e=>{if(!d)return!0;let t=e.session;return t.name&&t.name.toLowerCase().includes(d)||t.host&&t.host.toLowerCase().includes(d)||t.username&&t.username.toLowerCase().includes(d)||t.environment&&t.environment.toLowerCase().includes(d)},p=e=>{let n=e.session,a=e.nodeId||``,o=mo(n),s=e.folder?i(e.folder.name):null,c=s||r(n.environment||n.color),l=(s?s.color:n.color)||(c?c.color:``),u=(n.name||n.host||`Session`).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),d=`${n.username?n.username+`@`:``}${n.host||``}${n.port?`:`+n.port:``}`.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),f=Object.values(t).some(e=>e.profile&&e.profile.id===n.id&&e.isConnected),p=l?`style="--card-accent:${l}; border-top: 3px solid ${l};"`:``,m=c?`<span class="card-env-badge env-${c.key}" style="color:${c.color}; background:${c.bg}; border:1px solid ${c.border};" title="Environment: ${c.name}">${c.label}</span>`:`<span class="card-env-badge card-env-default" title="No environment set">DEFAULT</span>`;return`
    ...
    `,document.body.appendChild(e),e.addEventListener(`click`,t=>{t.target===e&&Oo()});let t=e.querySelector(`#commandPaletteInput`);t.addEventListener(`input`,()=>{wo=0,ko()}),t.addEventListener(`keydown`,e=>{e.key===`Escape`?(e.preventDefault(),Oo()):e.key===`ArrowDown`?(e.preventDefault(),To.length>0&&(wo=(wo+1)%To.length,Ao())):e.key===`ArrowUp`?(e.preventDefault(),To.length>0&&(wo=(wo-1+To.length)%To.length,Ao())):e.key===`Enter`&&(e.preventDefault(),To[wo]&&Mo(To[wo]))})}e.classList.remove(`hidden`),e.style.display=`flex`;let t=e.querySelector(`#commandPaletteInput`);t.value=``,ko(),setTimeout(()=>t.focus(),20)}function Oo(){Co=!1;let e=document.getElementById(`commandPaletteModal`);e&&(e.classList.add(`hidden`),e.style.display=`none`)}function ko(){let e=document.getElementById(`commandPaletteInput`),n=document.getElementById(`commandPaletteResults`);if(!n)return;let r=(e?e.value:``).trim().toLowerCase(),i=[...So];if(Object.entries(t).forEach(([e,t])=>{t&&t.profile&&i.push({id:`tab-jump-${e}`,category:`Open Tabs`,title:`Switch to: ${t.profile.name||t.profile.host||`Terminal`}`,subtitle:`${t.profile.host||``} (${t.isConnected?`Connected`:`Disconnected`})`,icon:`⚡`,action:()=>{t.activateTabFn&&t.activateTabFn(e)}})}),To=r?i.filter(e=>{let t=e.title&&e.title.toLowerCase().includes(r),n=e.subtitle&&e.subtitle.toLowerCase().includes(r),i=e.category&&e.category.toLowerCase().includes(r);return t||n||i}):i,To.length===0){n.innerHTML=`
      <div class="command-palette-empty">No commands or sessions match "${No(r)}"</div>
    `;return}let a=``,o=``;To.forEach((e,t)=>{e.category&&e.category!==o&&(o=e.category,a+=`<div class="command-palette-category">${No(o)}</div>`),a+=`
      <div class="command-palette-item ${t===wo?`selected`:``}" data-index="${t}">
        <span class="palette-item-icon">${e.icon||`▸`}</span>
        <div class="palette-item-info">
          <span class="palette-item-title">${No(e.title)}</span>
          ${e.subtitle?`<span class="palette-item-sub">${No(e.subtitle)}</span>`:``}
        </div>
        ${e.shortcut?`<span class="palette-item-shortcut">${No(e.shortcut)}</span>`:``}
      </div>
    `}),n.innerHTML=a,n.querySelectorAll(`.command-palette-item`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{wo=parseInt(e.dataset.index,10),Ao()}),e.addEventListener(`click`,()=>{let t=parseInt(e.dataset.index,10);To[t]&&Mo(To[t])})}),jo()}function Ao(){let e=document.getElementById(`commandPaletteResults`);e&&(e.querySelectorAll(`.command-palette-item`).forEach((e,t)=>{e.classList.toggle(`selected`,t===wo)}),jo())}function jo(){let e=document.getElementById(`commandPaletteResults`);if(!e)return;let t=e.querySelector(`.command-palette-item.selected`);t&&t.scrollIntoView({block:`nearest`})}function Mo(e){if(Oo(),typeof e.action==`function`)try{e.action()}catch(e){console.error(`Error executing palette command:`,e)}}function No(e){return e?String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]):``}var Po=null,Fo={cpu:`2.4%`,ram:`11.6 / 30.9 GB`,netUp:`0.01 MB/s`,netDown:`0.12 MB/s`,uptime:`65d`,disks:[{mount:`/`,usage:`14%`},{mount:`/opt`,usage:`28%`},{mount:`/home`,usage:`3%`}]};function Io(){let e=document.getElementById(`statusBar`);e&&(e.addEventListener(`click`,e=>{(e.target.closest(`.status-server-pill`)||e.target.closest(`#activeTargetText`))&&Ro()}),Lo(),Po&&clearInterval(Po),Po=setInterval(()=>{Lo()},3e3))}function Lo(){let e=n(),t=T(),r=Object.keys(t).length,i=document.getElementById(`activeSessionsCount`);i&&(i.textContent=`${r} active tab${r===1?``:`s`}`);let a=document.getElementById(`activeTargetText`);if(!a)return;if(!e||!e.profile){a.innerHTML=`<span class="status-idle-pill">○ Workspace Ready</span>`;return}let o=e.profile,s=e.isConnected,c=e.environment||{label:`DEV`,color:`#3b82f6`},l=(o.protocol||`ssh`).toUpperCase(),u=`${e.serialNo?`[${e.serialNo}] `:``}${e.remoteHostname||(o.name&&o.name!==`New Server`&&o.name!==`New Session`?o.name:o.host||`Terminal`)}`;a.innerHTML=`
  ...
  `}function Ro(){let e=document.getElementById(`serverDetailsPopover`);if(e){e.remove();return}let t=n();if(!t||!t.profile)return;let r=t.profile,i=t.environment||{label:`DEV`,name:`Development`,color:`#3b82f6`},a=`${t.serialNo?`[${t.serialNo}] `:``}${t.remoteHostname||(r.name&&r.name!==`New Server`&&r.name!==`New Session`?r.name:r.host||`Terminal`)}`,o=`${r.username?r.username+`@`:``}${r.host||`localhost`}${r.port?`:`+r.port:``}`;e=document.createElement(`div`),e.id=`serverDetailsPopover`,e.className=`server-details-popover`,e.innerHTML=`
    ...
    <div class="popover-body">
      ...
      <div class="metric-row">
        ...
        <span class="metric-val">↑ ${Fo.netUp}  ↓ ${Fo.netDown}</span>
      </div>
      <div class="metric-row">
        <span class="metric-label">Server Uptime</span>
        <span class="metric-val">${Fo.uptime}</span>
      </div>
    </div>
  `,document.body.appendChild(e),e.querySelector(`.popover-close-btn`).addEventListener(`click`,()=>{e.remove()});let s=t=>{!e.contains(t.target)&&!t.target.closest(`.status-server-pill`)&&(e.remove(),window.removeEventListener(`click`,s))};setTimeout(()=>{window.addEventListener(`click`,s)},10)}function zo(e){return e?String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]):``}var Bo=!1;function Vo(e={}){let t=document.getElementById(`sidebar`);if(!t)return;let n=document.getElementById(`sidebarCollapseToggle`);n||(n=document.createElement(`button`),n.id=`sidebarCollapseToggle`,n.className=`sidebar-collapse-toggle`,n.title=`Toggle Sidebar Collapse (Ctrl+B)`,n.innerHTML=`◀`,t.appendChild(n),n.addEventListener(`click`,()=>{Ho()})),document.querySelectorAll(`.nav-category-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.section;n&&Wo(n,e)})}),window.addEventListener(`resize`,()=>{window.innerWidth<850&&!Bo&&Uo(!0)}),window.innerWidth<850&&Uo(!0)}function Ho(){Uo(!Bo)}function Uo(e){Bo=e;let t=document.getElementById(`sidebar`),n=document.getElementById(`sidebarCollapseToggle`);t&&(t.classList.toggle(`collapsed`,Bo),n&&(n.innerHTML=Bo?`▶`:`◀`,n.title=Bo?`Expand Sidebar`:`Collapse Sidebar`),setTimeout(()=>{window.dispatchEvent(new Event(`resize`))},160))}function Wo(e,t={}){switch(document.querySelectorAll(`.nav-category-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.section===e)}),e){case`home`:t.onOpenHome&&t.onOpenHome();break;case`sessions`:t.onOpenSessions&&t.onOpenSessions();break;case`sftp`:t.onOpenSFTP&&t.onOpenSFTP();break;case`broadcast`:t.onOpenBroadcast&&t.onOpenBroadcast();break;case`multiexec`:t.onOpenMultiExec&&t.onOpenMultiExec();break;case`tunneling`:t.onOpenTunneling&&t.onOpenTunneling();break;case`settings`:t.onOpenSettings&&t.onOpenSettings()}}v({activateTab:Pn,closeTab:Fn,showNewSessionDialog:J,showTabContextMenu:Bn,activateHomeTab:Nn}),Eo([{id:`cmd-new-session`,category:`Sessions`,title:`New Session...`,subtitle:`Create a new SSH, Telnet, Serial or VNC session`,icon:`＋`,shortcut:`Ctrl+N`,action:()=>J()},{id:`cmd-new-folder`,category:`Sessions`,title:`New Folder...`,subtitle:`Create an environment or organization folder`,icon:`📁`,action:()=>ya()},{id:`cmd-home`,category:`Navigation`,title:`Go to Home Dashboard`,subtitle:`View recent sessions and tools`,icon:`🏠`,action:()=>Nn()},{id:`cmd-local-term`,category:`Sessions`,title:`New Local Terminal`,subtitle:`Start a local PowerShell or Command Prompt tab`,icon:`💻`,action:()=>zn(`powershell`)},{id:`cmd-split-vert`,category:`Workspace`,title:`Split Right (Vertical Split)`,subtitle:`Split active pane side-by-side`,icon:`◫`,shortcut:`Ctrl+Shift+E`,action:()=>D(x.activePaneId,`right`)},{id:`cmd-split-horiz`,category:`Workspace`,title:`Split Down (Horizontal Split)`,subtitle:`Split active pane top and bottom`,icon:`⬒`,shortcut:`Ctrl+Shift+O`,action:()=>D(x.activePaneId,`down`)},{id:`cmd-single-pane`,category:`Workspace`,title:`Single Pane Mode`,subtitle:`Reset workspace to one active pane`,icon:`◻`,action:()=>b(`single`)},{id:`cmd-grid-pane`,category:`Workspace`,title:`2x2 Grid Workspace`,subtitle:`Split terminal workspace into 4 quadrants`,icon:`⊞`,action:()=>b(`grid`)},{id:`cmd-sftp`,category:`Tools`,title:`Open SFTP File Browser`,subtitle:`Browse local and remote files with dual-pane transfer`,icon:`📂`,action:()=>$(`sftp`)},{id:`cmd-broadcast`,category:`Tools`,title:`Broadcast Command...`,subtitle:`Send a command to all or selected connected servers`,icon:`⚡`,shortcut:`Ctrl+Alt+B`,action:()=>Xe(`all`)},{id:`cmd-multiexec`,category:`Tools`,title:`Toggle MultiExec Bar`,subtitle:`Simultaneous keystroke streaming bar`,icon:`⚡`,shortcut:`Alt+M`,action:()=>qn()},{id:`cmd-find-term`,category:`Terminal`,title:`Find in Terminal...`,subtitle:`Search terminal scrollback buffer`,icon:`🔍`,shortcut:`Ctrl+Shift+F`,action:()=>{y&&t[y]&&me(y)}},{id:`cmd-tunneling`,category:`Network`,title:`Nexterm Tunnel Manager...`,subtitle:`SSH local/remote/dynamic port forwarding`,icon:`🔑`,action:()=>er()},{id:`cmd-settings`,category:`System`,title:`Preferences & Settings...`,subtitle:`Configure themes, fonts, credentials and audit logging`,icon:`⚙`,action:()=>yr()},{id:`cmd-theme`,category:`Appearance`,title:`Choose UI Theme...`,subtitle:`Select between Dark Modern, One Dark, Nord, or Dracula`,icon:`🎨`,action:()=>vr()},{id:`cmd-recorder`,category:`Automation`,title:`Session Recorder...`,subtitle:`Record, edit and replay a sequence of commands`,icon:`⏺`,action:()=>Nt()},{id:`cmd-record-toggle`,category:`Automation`,title:`Start / Stop Recording`,subtitle:`Capture the commands you run on the active terminal`,icon:`●`,action:()=>kt()},{id:`cmd-scheduler`,category:`Automation`,title:`Command Scheduler...`,subtitle:`Auto-run a command or recording once or on a repeating interval`,icon:`⏱️`,action:()=>ki()},{id:`cmd-history`,category:`Automation`,title:`Command History...`,subtitle:`Search and re-run any command you've run over SSH`,icon:`🕘`,action:()=>Vt()},{id:`cmd-server-tools`,category:`Automation`,title:`Server Tools (Notes / Quick / Startup)...`,subtitle:`Per-server notes, one-click commands, and startup commands`,icon:`🗂️`,action:()=>en()},{id:`cmd-processes`,category:`Server`,title:`Process Explorer...`,subtitle:`Live processes on the server, with details and kill`,icon:`🧩`,action:()=>Bi()},{id:`cmd-ports`,category:`Server`,title:`Ports & Services...`,subtitle:`Listening ports and the process behind each`,icon:`🔌`,action:()=>qi()},{id:`cmd-logs`,category:`Server`,title:`Log Explorer...`,subtitle:`Live-tail a remote log with search, regex and error filters`,icon:`📜`,action:()=>$i()},{id:`cmd-intel`,category:`Server`,title:`Command Intelligence...`,subtitle:`Type an intent; get the explicit command to run`,icon:`✨`,action:()=>sa()}]);function Go(){document.querySelectorAll(`.menu-item`).forEach(e=>{e.onclick=t=>{t.stopPropagation();let n=e.querySelector(`.dropdown-menu`);if(!n)return;let r=n.classList.contains(`hidden`);document.querySelectorAll(`.dropdown-menu`).forEach(e=>e.classList.add(`hidden`)),r&&n.classList.remove(`hidden`)}}),window.addEventListener(`click`,()=>{document.querySelectorAll(`.dropdown-menu`).forEach(e=>e.classList.add(`hidden`)),R()});let e=(e,t)=>{let n=document.getElementById(e);n&&(n.onclick=t)};e(`mStartLocal`,()=>zn(`powershell`)),e(`mNewSSH`,()=>J()),e(`mNewSession`,()=>J()),e(`mNewFolder`,()=>ya()),e(`mToggleMultiExec`,qn),e(`mOpenCommandPalette`,Do),e(`mSwitchTheme`,vr),e(`mOpenTunneling`,er),e(`mOpenSettings`,yr),e(`mRecordMacro`,ar),e(`mStartXServer`,async()=>{if(!(window.go&&window.go.main&&window.go.main.App&&window.go.main.App.LaunchXServer)){S(`X Server support requires rebuilding the app (run.bat)`,`error`);return}try{let e=await window.go.main.App.LaunchXServer();S(e||`X server started`,`success`)}catch(e){S(`X Server: `+e,`warning`)}}),e(`mImportSessions`,()=>{let e=document.getElementById(`treeImportBtn`);e&&e.click()}),e(`mExportSessions`,()=>{let e=document.getElementById(`treeExportBtn`);e&&e.click()}),e(`mSaveGroup`,()=>ui()),e(`mManageGroups`,()=>pi()),e(`mCloseTab`,()=>{y&&y!==`home`&&Fn(y)}),e(`mClearTab`,()=>{y&&t[y]&&t[y].term.clear()}),e(`mFindInTerm`,()=>{y&&t[y]&&me(y)}),e(`mDuplicateTab`,()=>{y&&t[y]&&Ln(y)}),e(`mSnippets`,()=>xi()),e(`mShortcuts`,()=>pa()),e(`mAbout`,()=>S(`NexTerm — Professional SSH & Terminal Manager (Connect Beyond Limits)`,`info`)),e(`mToggleLogging`,()=>{y&&y!==`home`?On(y):S(`Open a terminal tab first`,`warning`)});let n=()=>{let e=document.getElementById(`mAutoLogState`);e&&(e.textContent=wn()?`On`:`Off`)};n(),e(`mToggleAutoLog`,()=>{Tn(!wn()),n(),S(wn()?`New sessions will be auto-logged`:`Auto-logging disabled`,`info`)}),e(`mOpenLogsFolder`,()=>{window.go&&window.go.main&&window.go.main.App&&window.go.main.App.OpenSessionLogFolder&&window.go.main.App.OpenSessionLogFolder()});let r=e=>{document.querySelectorAll(`.nav-rail-btn`).forEach(t=>t.classList.toggle(`active`,t.id===e)),document.body.classList.toggle(`on-home`,e===`navRailHomeBtn`)},i=()=>{document.getElementById(`navRail`)?.classList.add(`open`),document.getElementById(`navBackdrop`)?.classList.add(`show`)},a=()=>{document.getElementById(`navRail`)?.classList.remove(`open`),document.getElementById(`navBackdrop`)?.classList.remove(`show`)};e(`topMenuToggle`,()=>{let e=document.getElementById(`navRail`);e&&e.classList.contains(`open`)?a():i()}),e(`navRailPin`,a);let o=document.getElementById(`navBackdrop`);o&&(o.onclick=a),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&a()}),document.getElementById(`navRail`)?.addEventListener(`click`,e=>{e.target.closest(`button`)&&e.target.closest(`button`).id!==`navRailPin`&&a()}),document.body.classList.add(`on-home`);let s=document.getElementById(`welcomeState`);if(s){let e=()=>{document.body.classList.toggle(`on-home`,s.classList.contains(`active`))};new MutationObserver(e).observe(s,{attributes:!0,attributeFilter:[`class`]}),e()}let c=(e,t,n=!0)=>{let i=document.getElementById(e);i&&(i.onclick=()=>{n&&r(e),t(),a()})};c(`navRailHomeBtn`,()=>Nn());let l=document.getElementById(`navRailHome`);l&&(l.onclick=()=>{r(`navRailHomeBtn`),Nn()}),c(`navRailTerminal`,()=>zn(`powershell`),!1),c(`navRailSessions`,()=>$(`sessions`)),c(`navRailServers`,async()=>{if($(`sessions`),window.go&&window.go.main&&window.go.main.App&&window.go.main.App.ExpandAllFolders)try{await window.go.main.App.ExpandAllFolders(!0)}catch{}await Q()}),c(`navRailSFTP`,()=>$(`sftp`)),c(`navRailTools`,()=>$(`tools`)),c(`navRailMacros`,()=>$(`macros`)),c(`navRailTunneling`,()=>er(),!1),c(`navRailBroadcast`,()=>Xe(`all`),!1),c(`navRailWorkspaces`,()=>pi(),!1),c(`navRailSettings`,()=>yr(),!1);function u(){return(document.documentElement.getAttribute(`data-theme`)||``)===`light-modern`}function d(){let e=document.getElementById(`tbThemeToggleIcon`),t=document.getElementById(`tbThemeToggleBtn`);e&&(u()?(e.innerHTML=`<circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line>`,t&&(t.title=`Light mode — click for Dark`)):(e.innerHTML=`<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>`,t&&(t.title=`Dark mode — click for Light`)))}function f(){if(u()){let e=`dark-modern`;try{e=localStorage.getItem(`nexterm_last_dark_theme`)||`dark-modern`}catch{}e===`light-modern`&&(e=`dark-modern`),_r(e,!0)}else{let e=document.documentElement.getAttribute(`data-theme`)||`dark-modern`;try{localStorage.setItem(`nexterm_last_dark_theme`,e)}catch{}_r(`light-modern`,!0)}d()}d(),O(),e(`tbSessionBtn`,()=>J()),e(`tbServersBtn`,async()=>{if($(`sessions`),window.go&&window.go.main&&window.go.main.App&&window.go.main.App.ExpandAllFolders)try{await window.go.main.App.ExpandAllFolders(!0)}catch{}await Q()}),e(`tbToolsBtn`,()=>$(`tools`)),e(`tbSplitBtn`,e=>je(e.clientX,e.clientY+10)),e(`tbMultiExecBtn`,qn),e(`tbBroadcastBtn`,()=>Xe(`all`)),e(`connectedBroadcastBtn`,()=>Xe(`all`)),e(`tbMacrosBtn`,()=>$(`macros`)),e(`tbTunnelingBtn`,er),e(`tbPackagesBtn`,lr),e(`tbThemeBtn`,vr),e(`tbThemeToggleBtn`,f),e(`tbNotifBtn`,_),e(`tbSettingsBtn`,yr),e(`tbCommandPaletteBtn`,Do),e(`tbMonitorBtn`,()=>Er()),e(`tbXServerBtn`,async()=>{if(!(window.go&&window.go.main&&window.go.main.App&&window.go.main.App.LaunchXServer)){S(`X Server support requires rebuilding the app (run.bat)`,`error`);return}try{let e=await window.go.main.App.LaunchXServer();S(e||`X server started`,`success`)}catch(e){S(`X Server: `+e,`warning`)}}),e(`tbExitBtn`,()=>{confirm(`Exit Nexterm?`)&&window.close()}),e(`topBrandHome`,()=>{r(`navRailHomeBtn`),Nn()});let p=document.getElementById(`topGlobalSearch`);p&&(p.addEventListener(`focus`,()=>Do()),p.addEventListener(`keydown`,e=>{e.key===`Enter`&&Do()}));let m=()=>window.runtime||window.wails&&window.wails.runtime||null;e(`winMinBtn`,()=>{let e=m();e&&e.WindowMinimise&&e.WindowMinimise()}),e(`winMaxBtn`,()=>{let e=m();e&&e.WindowToggleMaximise&&e.WindowToggleMaximise()}),e(`winCloseBtn`,()=>{let e=m();e&&e.Quit?e.Quit():window.close()}),e(`homeViewDocsBtn`,()=>{let e=m();if(e&&e.BrowserOpenURL)try{e.BrowserOpenURL(`https://github.com/gnmyt/Nexterm`);return}catch{}S(`Documentation is available in the project README`,`info`)}),e(`homeTermNewBtn`,()=>J()),e(`homeTermExpandBtn`,()=>{let e=Object.keys(t).filter(e=>e!==`home`&&e!==`welcome`);if(e.length>0)try{Pn(e[0]);return}catch{}zn(`powershell`)}),document.querySelectorAll(`.nav-ws-item`).forEach(e=>{e.onclick=()=>{let t=e.getAttribute(`data-ws`)||``;Nn();let n=document.getElementById(`welcomeSearchInput`);n&&(n.value=t);try{Q(t)}catch{}}}),c(`navRailMonitor`,()=>Er(),!1),c(`navRailRecorder`,()=>Nt(),!1),c(`navRailScheduler`,()=>ki(),!1),c(`navRailHistory`,()=>Vt(),!1),c(`navRailServerTools`,()=>en(),!1),c(`navRailProcesses`,()=>Bi(),!1),c(`navRailPorts`,()=>qi(),!1),c(`navRailLogs`,()=>$i(),!1),c(`navRailCmdIntel`,()=>sa(),!1),Oi(),c(`navRailXServer`,async()=>{if(!(window.go&&window.go.main&&window.go.main.App&&window.go.main.App.LaunchXServer)){S(`X Server support requires rebuilding the app (run.bat)`,`error`);return}try{S(await window.go.main.App.LaunchXServer()||`X server started`,`success`)}catch(e){S(`X Server: `+e,`warning`)}},!1),e(`navRailSplit`,e=>je(e.clientX,e.clientY+10)),e(`navRailMultiExec`,qn),e(`navRailPackages`,lr),e(`navRailThemes`,vr);function h(){let e=document.getElementById(`sysActiveSessions`),n=document.getElementById(`sysSavedServers`);if(e){let n=Object.keys(t).filter(e=>e!==`home`&&e!==`welcome`).length;e.textContent=String(n)}if(n){let e=document.querySelectorAll(`#recentSessionsGrid .recent-session-card`).length;n.textContent=String(e)}}h(),setInterval(h,4e3),e(`multiExecSendBtn`,An),e(`multiExecMatrixBtn`,qn),e(`multiExecCloseBtn`,kn);let g=document.getElementById(`multiExecInput`);g&&(g.onkeydown=e=>{e.key===`Enter`&&An()}),e(`navTabSessions`,()=>$(`sessions`)),e(`navTabSFTP`,()=>$(`sftp`)),e(`navTabMacros`,()=>$(`macros`)),e(`navTabTunnel`,()=>$(`tunnel`)),e(`navTabTools`,()=>$(`tools`)),e(`sftpFollowTermBtn`,()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first`,`warning`);return}let e=document.getElementById(`sftpFollowTermCheckbox`);e&&!e.checked&&(e.checked=!0),xe(y),S(`SFTP synchronized with terminal folder (${t[y].sftpPath||Y})`,`success`)}),e(`sftpDownloadBtn`,async()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first to download files`,`warning`);return}if(!X){S(`Please select a file to download`,`warning`);return}if(X.isDir){S(`Folder download not supported directly; please select a file`,`warning`);return}if(window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.SelectDownloadDest(X.name);e&&(S(`Downloading ${X.name}...`,`info`),await window.go.main.App.SFTPDownload(y,X.path,e),S(`Downloaded ${X.name} successfully`,`success`))}catch(e){S(`Download failed: `+e,`error`)}}),e(`sftpUploadBtn`,async()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first to upload files via SFTP`,`warning`);return}if(window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.SelectUploadFile();if(e){let t=e.substring(e.lastIndexOf(`\\`)+1),n=(Y===`/`?``:Y)+`/`+t;S(`Uploading ${t}...`,`info`),await window.go.main.App.SFTPUpload(y,e,n),S(`Uploaded ${t} successfully`,`success`),await Z(Y)}}catch(e){S(`Upload failed: `+e,`error`)}}),e(`sftpRefreshBtn`,()=>Z(Y)),e(`sftpMkdirBtn`,async()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first to create folders`,`warning`);return}let e=prompt(`Enter new folder name:`);if(e&&window.go&&window.go.main&&window.go.main.App){let t=(Y===`/`?``:Y)+`/`+e.trim();try{await window.go.main.App.SFTPMkdir(y,t),S(`Folder "${e}" created`,`success`),await Z(Y)}catch(e){S(`Mkdir failed: `+e,`error`)}}}),e(`sftpNewFileBtn`,async()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first to create files`,`warning`);return}let e=prompt(`Enter new file name (e.g. test.txt, script.sh, main.c):`);if(e&&window.go&&window.go.main&&window.go.main.App){let t=(Y===`/`?``:Y)+`/`+e.trim();try{await window.go.main.App.SFTPCreateFile(y,t),S(`File "${e}" created`,`success`),await Z(Y)}catch(e){S(`Create file failed: `+e,`error`)}}}),e(`sftpDeleteBtn`,async()=>{if(!y||y===`home`||!t[y]||t[y].isLocal){S(`Open an SSH connection first`,`warning`);return}if(!X){S(`Please select a file or folder to delete`,`warning`);return}if(confirm(`Are you sure you want to delete "${X.name}" from remote server?`)&&window.go&&window.go.main&&window.go.main.App)try{await window.go.main.App.SFTPDelete(y,X.path),S(`Deleted ${X.name}`,`info`),await Z(Y)}catch(e){S(`Delete failed: `+e,`error`)}}),e(`sftpEditBtn`,()=>{if(!X||X.isDir){S(`Please select a file to edit in Nexterm Editor`,`warning`);return}Ka(X.path)}),e(`sftpToggleHiddenBtn`,()=>{eo(!Xa),S(Xa?`Showing hidden files (.*)`:`Hiding hidden files`,`info`),so(qa,Y)}),e(`sftpSyncBtn`,()=>{let e=document.getElementById(`sftpFollowTermCheckbox`);e&&(e.checked=!e.checked,S(e.checked?`Automatic Terminal-SFTP Directory Sync: ON`:`Automatic Terminal-SFTP Directory Sync: OFF`,e.checked?`success`:`info`),e.checked&&y&&t[y]&&!t[y].isLocal&&xe(y))});let v=document.getElementById(`sftpFollowTermCheckbox`);v&&v.addEventListener(`change`,()=>{S(v.checked?`Follow terminal folder: ON`:`Follow terminal folder: OFF`,v.checked?`success`:`info`),v.checked&&y&&t[y]&&!t[y].isLocal&&xe(y)}),e(`sftpPathDropdownBtn`,e=>{e.stopPropagation(),oo()}),document.querySelectorAll(`.moba-path-item`).forEach(e=>{e.addEventListener(`click`,()=>{ao();let t=e.dataset.path;t&&Z(t)})});let C=document.getElementById(`sftpPathInput`);C&&(C.onkeydown=e=>{e.key===`Enter`&&(ao(),Z(C.value.trim()))}),e(`sftpSortNameBtn`,()=>{Ja===`name`?$a(Ya===`asc`?`desc`:`asc`):(Qa(`name`),$a(`asc`));let e=document.getElementById(`sftpSortArrow`);e&&(e.textContent=Ya===`asc`?`▲`:`▼`),so(qa,Y)}),e(`sftpSortSizeBtn`,()=>{Ja===`size`?$a(Ya===`asc`?`desc`:`asc`):(Qa(`size`),$a(`asc`)),so(qa,Y)}),e(`sidebarNewMacroBtn`,ar),e(`sidebarNewTunnelBtn`,tr),e(`treeMultiConnectBtn`,()=>Fe()),e(`treeAddSessionBtn`,()=>J()),e(`treeAddFolderBtn`,()=>ya()),e(`treeExpandAllBtn`,async()=>{window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.ExpandAllFolders(!0),await Q()}),e(`treeCollapseAllBtn`,async()=>{window.go&&window.go.main&&window.go.main.App&&await window.go.main.App.ExpandAllFolders(!1),await Q()}),e(`treeRefreshBtn`,()=>Q()),e(`treeExportBtn`,async()=>{if(window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.ExportSessionsToFile();e&&S(`Sessions exported to ${e}`,`success`)}catch(e){S(`Export failed: `+e,`error`)}}),e(`treeImportBtn`,async()=>{if(window.go&&window.go.main&&window.go.main.App)try{await window.go.main.App.ImportSessionsFromFile(),await Q(),S(`Sessions imported successfully`,`success`)}catch(e){S(`Import failed: `+e,`error`)}});let T=async e=>{if(!e)return;let t=e.value.trim();if(!t){S(`Please enter a connection string (e.g. ssh user@192.168.1.20)`,`warning`),e.focus();return}let n=uo(t);if(!n||!n.host){S(`Invalid quick connect address: "${t}"`,`error`),e.focus();return}e.value=``;let r=n.protocol||`ssh`,i=n.port||22,a=i===22?``:`:${i}`,o=n.username||``,s=o?`${o}@${n.host}${a}`:`${n.host}${a}`;S(`Quick connecting to ${s}...`,`info`);let c=null,l=e=>{if(e&&!c){if(e.session){let t=e.session;if(t.host===n.host&&(t.port||22)===i&&(!o||!t.username||t.username===o)){c=t;return}}if(e.children){for(let t of e.children)if(l(t),c)return}}};if(l(I),c){let e={...c};o&&!e.username&&(e.username=o),V(e);return}let u=n.host.replace(/[^a-zA-Z0-9_-]/g,`_`);`${(o||`user`).replace(/[^a-zA-Z0-9_-]/g,`_`)}${u}${i}`;let d=window.crypto&&window.crypto.randomUUID?window.crypto.randomUUID():`sess-`+Date.now(),f={id:d,vaultKey:d,name:s,protocol:r,host:n.host,port:i,username:o,initialDir:n.initialDir||``,authType:`password`};if(window.go?.main?.App?.AddSession)try{await window.go.main.App.AddSession(``,f),await Q()}catch(e){console.warn(`Auto-saving quick connect session failed:`,e)}V(f)},E=document.getElementById(`quickConnectInput`),k=document.getElementById(`quickConnectBtn`);E&&E.addEventListener(`keydown`,e=>{e.key===`Enter`&&T(E)}),k&&k.addEventListener(`click`,()=>{T(E)});let A=document.getElementById(`sidebarQuickConnectInput`)||document.getElementById(`sidebarQuickConnect`);A&&A.addEventListener(`keydown`,e=>{e.key===`Enter`&&T(A)});let j=document.getElementById(`welcomeSearchInput`);j&&(j.oninput=()=>{Q(j.value)}),e(`startLocalTerminalBtn`,()=>zn(`powershell`)),e(`newSSHSessionBigBtn`,()=>J()),e(`homeMultiConnectBtn`,()=>Fe()),e(`homeBroadcastConnectBtn`,()=>Fe()),e(`homeAddServerBtn`,()=>J()),e(`homeToolSSH`,()=>J()),e(`homeToolSFTP`,()=>{$(`sftp`),S(`Switched to SFTP Browser in sidebar`,`info`)}),e(`homeToolTunnel`,er),e(`homeToolMacros`,()=>{$(`macros`),S(`Switched to Macros in sidebar`,`info`)}),e(`homeToolTaskMgr`,()=>{window.go&&window.go.main&&window.go.main.App&&window.go.main.App.LaunchSystemTool(`taskmgr`)}),e(`homeToolScanner`,pr);let M=document.getElementById(`homeTabBtn`);M&&(M.onclick=Nn),e(`newTabAddBtn`,()=>{J()}),e(`wsSettingsBtn`,yr),Object.entries({toolHardware:`devmgmt`,toolProcesses:`taskmgr`,toolCmdAdmin:`cmd_admin`,toolPSAdmin:`powershell_admin`,toolPorts:`resmon`}).forEach(([t,n])=>{e(t,()=>{window.go&&window.go.main&&window.go.main.App&&window.go.main.App.LaunchSystemTool(n),S(`Launching ${n}...`,`info`)})}),e(`toolPkgMgr`,lr),e(`toolTextEditor`,()=>Ka(``)),e(`toolDiff`,ur),e(`toolAscii`,dr),e(`toolPing`,or),e(`toolDNS`,sr),e(`toolScanner`,pr),e(`toolHash`,cr),e(`toolKeyGen`,fr),e(`toolTunnel`,er),window.addEventListener(`resize`,()=>{w()});let N=document.getElementById(`sidebar`),P=document.getElementById(`sidebarResizer`);if(N&&P){try{let e=parseInt(localStorage.getItem(`nexterm_sidebar_width`),10);e&&e>=180&&e<=640&&(N.style.width=e+`px`)}catch{}let e=!1;P.addEventListener(`mousedown`,t=>{e=!0,P.classList.add(`dragging`),document.body.style.cursor=`col-resize`,document.body.style.userSelect=`none`,t.preventDefault()}),window.addEventListener(`mousemove`,t=>{if(!e)return;let n=N.getBoundingClientRect().left,r=Math.max(180,Math.min(640,t.clientX-n));N.style.width=r+`px`}),window.addEventListener(`mouseup`,()=>{if(e){e=!1,P.classList.remove(`dragging`),document.body.style.cursor=``,document.body.style.userSelect=``;try{localStorage.setItem(`nexterm_sidebar_width`,String(parseInt(N.style.width,10)||290))}catch{}w()}}),P.addEventListener(`dblclick`,()=>{N.style.width=`290px`;try{localStorage.setItem(`nexterm_sidebar_width`,`290`)}catch{}w()})}window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(R(),U(),Oo());let n=/^(INPUT|TEXTAREA|SELECT)$/.test(e.target&&e.target.tagName||``);(e.key===`F1`||e.shiftKey&&e.key===`?`)&&!n&&(e.preventDefault(),pa()),e.altKey&&(e.key===`m`||e.key===`M`)&&(e.preventDefault(),qn()),(e.altKey&&(e.key===`b`||e.key===`B`)||(e.ctrlKey||e.metaKey)&&e.altKey&&(e.key===`b`||e.key===`B`))&&(e.preventDefault(),Xe(`all`)),(e.ctrlKey||e.metaKey)&&((e.key===`k`||e.key===`K`)&&!e.shiftKey&&(e.preventDefault(),Do()),(e.shiftKey&&(e.key===`F`||e.key===`f`)||!e.shiftKey&&(e.key===`f`||e.key===`F`))&&y&&t[y]&&(e.preventDefault(),me(y)),e.shiftKey&&(e.key===`E`||e.key===`e`)&&(e.preventDefault(),D(x.activePaneId,`right`)),e.shiftKey&&(e.key===`O`||e.key===`o`)&&(e.preventDefault(),D(x.activePaneId,`down`)),e.shiftKey&&(e.key===`M`||e.key===`m`)&&(e.preventDefault(),ee(x.activePaneId)),e.shiftKey&&(e.key===`|`||e.key===`\\`)&&(e.preventDefault(),b(x.layout===`split-v`?`single`:`split-v`)),e.shiftKey&&(e.key===`_`||e.key===`-`)&&(e.preventDefault(),b(x.layout===`split-h`?`single`:`split-h`)),e.key===`n`&&!e.shiftKey&&(e.preventDefault(),J()),e.key===`w`&&!e.shiftKey&&y&&y!==`home`&&(e.preventDefault(),Fn(y)))})}async function Ko(){let e=localStorage.getItem(`nexterm_settings`);if(e)try{let t=JSON.parse(e);Object.assign(W,t)}catch{}if(_r(W.uiTheme||W.theme||`dark-modern`,!1),window.go&&window.go.main&&window.go.main.App)try{let e=await window.go.main.App.GetCustomizerConfig();e&&e.appName&&(document.title=e.appName)}catch{}Go(),window.runtime&&window.runtime.EventsOn&&(window.runtime.EventsOn(`sftp:file:modified`,e=>{Ua(e)}),window.runtime.EventsOn(`ssh:hostkey:verify_request`,e=>{Qn(e)}),window.runtime.EventsOn(`ssh:auth:challenge_request`,e=>{Zn(e)})),await Q(),M(),Nn(),te(),bo(),Io(),Vo({onOpenHome:Nn,onOpenSessions:()=>$(`sessions`),onOpenSFTP:()=>$(`sftp`),onOpenBroadcast:()=>Xe(`all`),onOpenMultiExec:qn,onOpenTunneling:er,onOpenSettings:yr}),setTimeout(()=>{try{fi()}catch{}},1200)}document.readyState===`loading`?window.addEventListener(`DOMContentLoaded`,Ko):Ko();